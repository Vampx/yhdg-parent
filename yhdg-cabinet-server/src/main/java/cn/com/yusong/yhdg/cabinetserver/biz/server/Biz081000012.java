...
@Component
public  class Biz081000012 extends Biz {
    final Logger log = LogManager.getLogger(Biz081000012.class);
    ...
    public void doBiz(ChannelHandlerContext context, Map<String, Object> attributes, Object message) {
        ...
        Msg081000012 request = (Msg081000012) message;
        Msg082000012 response = new Msg082000012();
