package cn.com.yusong.yhdg.cabinetserver.comm.client;
...
public class ZkClient {
    ...
    public void startup() throws Exception {
        String path = ConstEnum.Node.NODE_CABINET_SERVER.getValue() + "/" + config.getZkName() + "-" + config.getServerIp() + ":" + config.getServerPort();
