...
import cn.com.yusong.yhdg.common.protocol.msg08.Msg081000005;
import cn.com.yusong.yhdg.common.protocol.msg08.Msg082000005;
 ...
 */
@Component
public class Biz081000005 extends AbstractBiz {
    ...
    public void doBiz(ChannelHandlerContext context, Map<String, Object> attributes, Object message) throws Exception {
        Msg081000005 request = (Msg081000005) message;
        Msg082000005 response = new Msg082000005();
        ...
        //创建分柜和格口
        Cabinet cabinet = cabinetService.insertOrUpdate(request.code, request.version, heartParam.temp1, heartParam.temp2, heartParam.network.intValue(), heartParam.signal.intValue(), heartParam.boxList, heartParam.fireState.intValue(), heartParam.degree, heartParam.fanSpeed.intValue(), heartParam.waterLevel.intValue(), heartParam.smokeState.intValue(), null, null);
        ...
        response.hasNewSubVersion = (byte) 0;
