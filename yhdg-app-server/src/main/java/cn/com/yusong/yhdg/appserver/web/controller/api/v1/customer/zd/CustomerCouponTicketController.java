...
@Controller("api_v1_customer_zd_customer_coupon_ticket")
@RequestMapping(value = "/api/v1/customer/zd/customer_coupon_ticket")
public class CustomerCouponTicketController extends ApiController {
    ...
    public RestResult list(@Valid @RequestBody ListParam param) {
        ...
        List<CustomerCouponTicket> ticketList = customerCouponTicketService.findList(param.agentId,
                customer.getMobile(), new Date(), param.ticketType, CustomerCouponTicket.Status.NOT_USER.getValue(), CustomerCouponTicket.Category.RENT.getValue(),null, null);
        if (ticketList != null) {
