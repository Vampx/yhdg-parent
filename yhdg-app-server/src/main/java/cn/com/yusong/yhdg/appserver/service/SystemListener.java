...
public class SystemListener {
    ...
    public void stop(ServletContext ServletContext) {
        ...
        if (appConfig.jobManager != null) {
            appConfig.jobManager.stop();
        }
    }
    ...
    void registerNode() throws Exception {
        String path = ConstEnum.Node.NODE_APP_SERVER.getValue() + ConstEnum.Node.NODE_APP_SERVER_CHILDREN.getValue();
        ...
        endpoint.create(ConstEnum.Node.NODE_APP_SERVER.getValue(), CreateMode.PERSISTENT);
        ...
        children = endpoint.addChildrenChangeListener(appConfig.cabinetServerClientManager, ConstEnum.Node.NODE_CABINET_SERVER.getValue());
