<script type="text/javascript" src="${contextPath}/webserver/static/tool/player/swfobject.js"></script>
<div class="video" id="CuPlayer"><b><img src="${contextPath}/webserver/static/tool/player/loading.gif" /> 网页视频播放器加载中，请稍后...</b></div>
<script type="text/javascript">
    var so = new SWFObject("${contextPath}/webserver/static/tool/player/player.swf","ply","100%","700","9","#000000");
    ...
    //播放器配置文件-----------------------------
    so.addVariable("JcScpFile","${contextPath}/webserver/static/tool/player/CuSunV2set.xml");
    //视频文件及略缩图--------------------------
    //so.addVariable("JcScpServer","rtmp://www.yoursite.com/vod");
    so.addVariable("JcScpVideoPath","${staticUrl}/security/material/download.htm?path=${path}");
    //-前置Flash广告-----------------------------
