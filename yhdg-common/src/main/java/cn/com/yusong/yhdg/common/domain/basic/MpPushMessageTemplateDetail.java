 ...
 * 推送消息模板详情
 */
public class MpPushMessageTemplateDetail extends StringIdEntity {
    ...
    public Integer getWeixinmpId() {
        return weixinmpId;
    }

    public void setWeixinmpId(Integer weixinmpId) {
        this.weixinmpId = weixinmpId;
    }
