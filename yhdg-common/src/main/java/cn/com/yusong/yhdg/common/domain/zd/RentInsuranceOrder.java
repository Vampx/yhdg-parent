...
@Getter
@Setter
public class RentInsuranceOrder extends StringIdEntity {
    ...
    public enum Status {
        ...
        static {
            for (RentInsuranceOrder.Status e : RentInsuranceOrder.Status.values()) {
    ...
    public String getStatusName() {
        if (status != null) {
            return RentInsuranceOrder.Status.getName(status);
        }
        return "";
    }
