...
public class Msg081000008 extends Msg081 {
    private static final Logger log = LogManager.getLogger(Msg081000008.class);
    ...
    public int getMsgCode() {
        return MsgCode.MSG_081000008.getCode();
    }
    ...
    public static class Box extends TypeOperator {
        ...
        public void read(ByteBuf buffer) {
            ...
            this.codeLength = buffer.readByte();
