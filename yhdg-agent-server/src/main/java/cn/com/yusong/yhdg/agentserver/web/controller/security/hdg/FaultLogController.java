...
import cn.com.yusong.yhdg.agentserver.service.hdg.FaultLogService;
...
public class FaultLogController extends SecurityController {
    ...
    public void index(Model model, Integer status) {
    ...
    @ResponseBody
    public PageResult page(FaultLog search, HttpSession httpSession) {
