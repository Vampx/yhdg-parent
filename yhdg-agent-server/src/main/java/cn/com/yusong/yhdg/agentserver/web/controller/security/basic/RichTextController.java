...
import cn.com.yusong.yhdg.agentserver.utils.ReadUrlUtils;
...
//    @SecurityControl(limits = OperCodeConst.CODE_1_7_2_1)
    @RequestMapping(value = "index.htm")
    public void index(Model model, Integer weixinmpId, Integer alipayfwId) throws Exception {
        if(weixinmpId != null){
...
//        model.addAttribute(MENU_CODE_NAME, AppConstEnum.Menu.MENU_01_07_02.getValue());
    }

    @RequestMapping("save.htm")
    @ViewModel(ViewModel.JSON)
    @ResponseBody
    public ExtResult save(long id, Integer weixinmpId, Integer alipayfwId, String content, Model model) throws IOException {
        if (weixinmpId == null && alipayfwId == null){
            return ExtResult.failResult("请先选择公众号或生活号");
        }
...
//        }
    ...
    public void read(long id, Integer weixinmpId, Integer alipayfwId, HttpServletResponse response) throws Exception {
        if (weixinmpId == null && alipayfwId == null){
            weixinmpId = 0;
        }
