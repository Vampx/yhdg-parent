...
import cn.com.yusong.yhdg.agentserver.persistence.hdg.CabinetDegreeInputMapper;
...
public class CabinetDegreeInputService extends AbstractService {
    ...
    public Page findPage(CabinetDegreeInput cabinetDegreeInput){
        ...
        List<CabinetDegreeInput> pageResult = cabinetDegreeInputMapper.findPageResult(cabinetDegreeInput);
    ...
    public Map<String,Object> findByCabinetId(String cabinetId,int agentId){
        Map<String,Object> map =new HashMap<String, Object>();
        List<CabinetDegreeInput> entity = cabinetDegreeInputMapper.findByCabinetId(cabinetId,agentId);
