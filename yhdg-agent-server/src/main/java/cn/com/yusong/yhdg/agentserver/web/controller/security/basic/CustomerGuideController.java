...
import cn.com.yusong.yhdg.agentserver.service.basic.CustomerGuideService;
...
//    @SecurityControl(limits = OperCodeConst.CODE_1_7_1_1)
    @RequestMapping(value = "index.htm")
    public void index(Model model) throws Exception {
        model.addAttribute("richTextEnum", ConstEnum.RichText.values());
//        model.addAttribute(MENU_CODE_NAME, AppConstEnum.Menu.MENU_01_07_01.getValue());
    }
