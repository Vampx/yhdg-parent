...
public interface CabinetMapper extends MasterMapper {
    ...
    List<Cabinet> findListByEstateId(@Param("estateId") long shopId);
    ...
    int updateRatio(@Param("id") String id, @Param("platformRatio") Integer platformRatio, @Param("agentRatio") Integer agentRatio, @Param("provinceAgentRatio") Integer provinceAgentRatio, @Param("cityAgentRatio") Integer cityAgentRatio, @Param("shopRatio") Integer shopRatio);
    int cleanDispatcherId(@Param("id") String id);

    int findCabinetCount(@Param("agentId") Integer agentId);
