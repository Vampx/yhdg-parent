...
public class DictItemServiceAspect {
    ...
    @Pointcut("execution(* cn.com.yusong.yhdg.agentserver.service.basic.DictItemService.findByCategory(..))")
    ...
    @Pointcut("execution(* cn.com.yusong.yhdg.agentserver.service.basic.DictItemService.update(..))")
    private void update() {}
    ...
    @Pointcut("execution(* cn.com.yusong.yhdg.agentserver.service.basic.DictItemService.insert(..))")
    private void insert() {}
    ...
    @Pointcut("execution(* cn.com.yusong.yhdg.agentserver.service.basic.DictItemService.delete(..))")
    private void delete() {}
    ...
    @Pointcut("execution(* cn.com.yusong.yhdg.agentserver.service.basic.DictItemService.updateOrderNum(..))")
