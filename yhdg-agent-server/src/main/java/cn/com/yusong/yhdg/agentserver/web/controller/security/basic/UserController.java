...
//    @SecurityControl(limits = OperCodeConst.CODE_7_1_1_1)
    @RequestMapping(value = "index.htm")
    public void index(Model model) {
//        model.addAttribute(MENU_CODE_NAME, AppConstEnum.Menu.MENU_07_01_01.getValue());
    }
    ...
    @RequestMapping("create_shop_user.htm")
    @ViewModel(ViewModel.JSON)
    @ResponseBody
    public ExtResult createShopUser(User entity) throws IOException {
        entity.setIsAdmin(ConstEnum.Flag.FALSE.getValue());
        entity.setIsProtected(ConstEnum.Flag.FALSE.getValue());
        return userService.createShopUser(entity);
    }
    ...
    @RequestMapping("update_shop_user.htm")
    @ViewModel(ViewModel.JSON)
    @ResponseBody
    public ExtResult updateShopUser(User entity) throws IOException {
        return userService.updateShopUser(entity);
    }
    ...
    @RequestMapping("estate_user_page.htm")
    @ViewModel(ViewModel.JSON)
    @ResponseBody
    public PageResult estateUserPage(User search) {
    ...
    @RequestMapping("create_estate_user.htm")
    @ViewModel(ViewModel.JSON)
    @ResponseBody
    public ExtResult createEstateUser(User entity) throws IOException {
        entity.setIsAdmin(ConstEnum.Flag.FALSE.getValue());
        entity.setIsProtected(ConstEnum.Flag.FALSE.getValue());
        return userService.createEstateUser(entity);
    }

    @RequestMapping("update_estate_user.htm")
    @ViewModel(ViewModel.JSON)
    @ResponseBody
    public ExtResult updateEstateUser(User entity) throws IOException {
        return userService.updateEstateUser(entity);
    }
