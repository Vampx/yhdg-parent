...
@Controller
@RequestMapping(value = "/security/zc/vehicle_customer_foregift_order")
public class VehicleCustomerForegiftOrderController extends SecurityController {
    @Autowired
    ...
    @SecurityControl(limits = "zc.VehicleCustomerForegiftOrder:list")
    @RequestMapping(value = "index.htm")
    public void index(Model model) {
        model.addAttribute(MENU_CODE_NAME, "zc.VehicleCustomerForegiftOrder:list");
    ...
    public String view(Model model, String id) {
        ...
        return "/security/zc/vehicle_customer_foregift_order/view";
    }
    ...
    public String viewBasic(Model model, String id) {
        ...
        return "/security/zc/vehicle_customer_foregift_order/view_basic";
    }
    ...
    public String editRefund(Model model, String id,int refundFlag) {
        ...
        return "/security/zc/vehicle_customer_foregift_order/edit_refund";
    }

    @RequestMapping("refund.htm")
    @ViewModel(ViewModel.JSON)
    @ResponseBody
    public ExtResult refund(HttpSession httpSession, CustomerForegiftOrder customerForegiftOrder)throws AlipayApiException {
    ...
    public String editRepulseRefund(Model model, String id) {
        ...
        return "/security/zc/vehicle_customer_foregift_order/edit_repulse_refund";
    }
    ...
    public String portrait(@RequestParam("file") MultipartFile file, Model model) throws IOException {
        ...
        return "/security/zc/vehicle_customer_foregift_order/photo_path_response";
    }
