...
public class WeixinmpServiceAspect {
    ...
    @Pointcut("execution(* cn.com.yusong.yhdg.agentserver.service.basic.WeixinmpService.find(..))")
    private void find() {}
    @Around("find()")
    ...
    @Pointcut("execution(* cn.com.yusong.yhdg.agentserver.service.basic.WeixinmpService.update(..))")
    private void update() {}
    @Around("update()")
    ...
    @Pointcut("execution(* cn.com.yusong.yhdg.agentserver.service.basic.WeixinmpService.delete(..))")
    private void delete() {}
    @Around("delete()")
