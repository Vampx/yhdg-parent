...
import cn.com.yusong.yhdg.agentserver.service.basic.UpgradePackService;
 ...
 */
@Controller
@RequestMapping(value = "/security/basic/screen_upgrade_pack")
public class ScreenUpgradePackController extends SecurityController {
    final static String UPGRADE_URL = "/security/upload/upgrade.htm";

    @Autowired
    UpgradePackService upgradePackService;

//    @SecurityControl(limits = OperCodeConst.CODE_7_4_2_1)
    @RequestMapping("index.htm")
    public void index(String menuCode,Model model) throws Exception {
        model.addAttribute(MENU_CODE_NAME, menuCode);
//        model.addAttribute(MENU_CODE_NAME, AppConstEnum.Menu.MENU_07_04_02.getValue());
    }
    ...
    public PageResult page(UpgradePack search) {
        search.setId((long)ConstEnum.Flag.TRUE.getValue());
        return PageResult.successResult(upgradePackService.findScreenPage(search));
    }
    ...
    public String edit(int id, Model model) {
        ...
        return "/security/basic/screen_upgrade_pack/edit";
    }
    ...
    public String view(int id, Model model) {
        ...
        model.addAttribute("entity", upgradePack);
        return "/security/basic/screen_upgrade_pack/view";
    }
