...
@Controller
@RequestMapping(value = "/security/zd/rent_foregift_order")
public class RentForegiftOrderController extends SecurityController {
    @Autowired
    private RentForegiftOrderService rentForegiftOrderService;
    @Autowired
    ...
    @SecurityControl(limits = "zd.RentForegiftOrder:list")
    @RequestMapping(value = "index.htm")
    public void index(Model model) {
        model.addAttribute(MENU_CODE_NAME, "zd.RentForegiftOrder:list");
    ...
    public String view(Model model, String id) {
        ...
        return "/security/zd/rent_foregift_order/view";
    }
    ...
    public String viewBasic(Model model, String id) {
        ...
        return "/security/zd/rent_foregift_order/view_basic";
    }
    ...
    public String editRefund(Model model, String id,int refundFlag) {
        ...
        return "/security/zd/rent_foregift_order/edit_refund";
    }
    ...
    public String editRepulseRefund(Model model, String id) {
        ...
        return "/security/zd/rent_foregift_order/edit_repulse_refund";
    }
    ...
    public String portrait(@RequestParam("file") MultipartFile file, Model model) throws IOException {
        ...
        return "/security/zd/rent_foregift_order/photo_path_response";
    }
