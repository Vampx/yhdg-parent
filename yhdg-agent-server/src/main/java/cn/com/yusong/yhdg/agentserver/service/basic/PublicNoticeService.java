...
import cn.com.yusong.yhdg.agentserver.persistence.basic.PublicNoticeMapper;
...
public class PublicNoticeService extends AbstractService {
    ...
    public ExtResult create(PublicNotice publicNotice) {
        ...
        //pushMetaDataCreate(publicNotice.getId().toString(), PushMessage.SourceType.PUBLIC_NOTICE.getValue());
    ...
    private int pushMetaDataCreate(String sourceId,Integer sourceType) {
