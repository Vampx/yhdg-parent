...
import cn.com.yusong.yhdg.agentserver.service.hdg.ShopStoreBatteryService;
 ...
 */
@Controller
@RequestMapping(value = "/security/zc/vehicle_battery_order")
public class VehicleBatteryOrderController extends SecurityController {
    ...
    @SecurityControl(limits = "zc.VehicleBatteryOrder:list")
    @RequestMapping(value = "index.htm")
    public void index(Model model) {
        model.addAttribute(MENU_CODE_NAME, "zc.VehicleBatteryOrder:list");
    ...
    public String selectPacketPeriodOrder(Model model,Integer agentId, String balanceDate) {
        ...
        return "/security/zc/vehicle_battery_order/select_battery_order";
    }
    ...
    public String view(Model model, String id) {
        ...
        return "/security/zc/vehicle_battery_order/view";
    }
    ...
    public String viewBasic(Model model, String id) {
        ...
        model.addAttribute("PayTypeEnum", ConstEnum.PayType.values());
        model.addAttribute("OrderStatusEnum", BatteryOrder.OrderStatus.values());
        return "/security/zc/vehicle_battery_order/view_basic";
    }
    ...
    public String editRefund(Model model, String id) {
        ...
        return "/security/zc/vehicle_battery_order/edit_refund";
    }
    ...
    public ExtResult exchangeBattery(String id, String batteryId) {
        ...
        if(newShopStoreBattery!=null){
            return ExtResult.failResult("电池已绑定门店无法更换");
        }
