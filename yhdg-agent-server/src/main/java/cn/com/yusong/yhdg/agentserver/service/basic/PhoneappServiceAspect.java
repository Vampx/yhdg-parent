...
public class PhoneappServiceAspect {
    ...
    @Pointcut("execution(* cn.com.yusong.yhdg.agentserver.service.basic.PhoneappService.find(..))")
    private void find() {}
    @Around("find()")
    ...
    @Pointcut("execution(* cn.com.yusong.yhdg.agentserver.service.basic.PhoneappService.update(..))")
    private void update() {}
    @Around("update()")
    ...
    @Pointcut("execution(* cn.com.yusong.yhdg.agentserver.service.basic.PhoneappService.delete(..))")
    private void delete() {}
    @Around("delete()")
