...
import cn.com.yusong.yhdg.agentserver.service.hdg.PlatformDayStatsService;
...
//    @SecurityControl(limits = OperCodeConst.CODE_6_3_3_1)
    @RequestMapping(value = "index.htm")
    public void index(Model model) {
        List<Agent> agentList = agentService.findAll();
        model.addAttribute("agentList", agentList);
//        model.addAttribute(MENU_CODE_NAME, AppConstEnum.Menu.MENU_06_03_03.getValue());
    }
