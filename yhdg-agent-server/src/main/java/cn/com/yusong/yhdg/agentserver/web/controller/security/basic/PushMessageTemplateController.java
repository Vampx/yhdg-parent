...
import cn.com.yusong.yhdg.agentserver.service.basic.PushMessageTemplateService;
...
//    @SecurityControl(limits = OperCodeConst.CODE_5_2_1_1)
    @RequestMapping(value = "index.htm")
    public void index(Model model) {
//        model.addAttribute(MENU_CODE_NAME, AppConstEnum.Menu.MENU_05_02_01.getValue());
    }
