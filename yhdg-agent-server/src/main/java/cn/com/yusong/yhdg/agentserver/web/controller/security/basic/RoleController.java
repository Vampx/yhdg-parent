...
//    @SecurityControl(limits = OperCodeConst.CODE_7_1_2_1)
    @RequestMapping(value = "index.htm")
    public void index(Model model) throws Exception {
//        model.addAttribute(MENU_CODE_NAME, AppConstEnum.Menu.MENU_07_01_02.getValue());
    }
    ...
    public ExtResult create(Role role, String operIds) {
    ...
    public ExtResult update(Role role, String operIds) {
        String[] str = StringUtils.split(operIds, ",");
        List<String> operList = new ArrayList<String>();
