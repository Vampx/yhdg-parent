    ...
    $(function() {
        ...
        $(".zj_list .battery_foregift .fa-edit").click(function () {
            ...
            App.dialog.show({
                ...
                title: '修改减免金额',
                href: "${contextPath}/security/zd/vip_rent_battery_foregift/vip_rent_battery_foregift_edit.htm?exchangeId=" + exchangeId + "&priceId=" +${(priceId)!0} + "&foregiftId="+ foregiftId,
                windowData:{
                },
                event: {
                    onClose: function() {
