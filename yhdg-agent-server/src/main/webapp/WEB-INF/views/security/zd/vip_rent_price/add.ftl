            ...
            <form method="post">
                <table cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td>
                             <input name="agentId" required="true" id="agent_id_${pid}" readonly value="${Session['SESSION_KEY_USER'].agentId}" class="easyui-combotree" editable="false"
    ...
    (function () {
        ...
        win.find('button.vip_ok').click(function () {
           ...
           /* var foregiftId = $(".zj_list").find(".selected").attr("battery_foregift_id");
            var reduceMoney = $('#reduce_money_').numberspinner('getValue');
            if (reduceMoney == '') {
