    ...
    <script>
        $(function () {
            $('#page_table').datagrid({
                ...
                striped: true,
                pagination: true,
                url: "${contextPath}/security/zd/zd_customer_installment_record/page.htm?agentId=${Session['SESSION_KEY_USER'].agentId}&category=2",
                fitColumns: true,
                pageSize: 50,
                pageList: [50, 100],
                idField: 'id',
                    ...
                    [
                        ...
                        },
                        {
                            ...
                            formatter: function(val, row) {
                                var html = '';
                                <@app.has_oper perm_code='zd.ZdCustomerInstallmentRecord:view'>
        ...
        function view(id) {
            App.dialog.show({
                ...
                title: '查看',
                href: "${contextPath}/security/zd/zd_customer_installment_record/view.htm?id=" + id,
            });
        }
