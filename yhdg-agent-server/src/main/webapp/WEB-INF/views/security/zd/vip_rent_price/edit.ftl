        ...
        <form method="post">
            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <tr id="exchange_battery_foregift">
                    <#include '../vip_rent_battery_foregift/vip_rent_battery_foregift.ftl'>
                </tr>
                <tr>
                    <td colspan="2">电池租金：</td>
                </tr>
                <tr id="exchange_packet_period_price">
                    <#include '../vip_rent_packet_period_price/vip_exchange_packet_period_price.ftl'>
                </tr>
                <tr>
                    <td colspan="2">绑定骑手号码：</td>
                </tr>
                <tr id="vip_price_customer">
                    <#include '../vip_rent_price_customer/vip_price_customer.ftl'>
                </tr>
                <tr>
                    <td colspan="2">绑定门店：</td>
                </tr>
                <tr id="vip_price_shop">
                    <#include '../vip_rent_price_shop/vip_price_shop.ftl'>
                </tr>
                <tr>
                    <td colspan="2">绑定运营公司：</td>
                </tr>
                <tr id="vip_price_agent_company">
                <#include '../vip_rent_price_agent_company/vip_price_agent_company.ftl'>
                </tr>
                <tr>
...
<script>
    ...
    //绑定的骑手
    $.post('${contextPath}/security/zd/vip_rent_price_customer/vip_price_customer.htm', {
        priceId: ${entity.id},
        agentId: ${(entity.agentId)!0}
    }, function (html) {
    ...
    //绑定的运营公司
    $.post('${contextPath}/security/zd/vip_rent_price_agent_company/vip_price_agent_company.htm', {
        priceId: ${entity.id},
        agentId: ${(entity.agentId)!0}
    }, function (html) {
    ...
    (function () {
        ...
        win.find('button.vip_ok').click(function () {
            ...
            form.form('submit', {
                url: '${contextPath}/security/zd/vip_rent_price/update.htm',
