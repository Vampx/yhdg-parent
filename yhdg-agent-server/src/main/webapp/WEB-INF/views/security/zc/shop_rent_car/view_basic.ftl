                    ...
                    <tr>
                        ...
                        <span class="radio_box">
                            <input type="radio" class="radio" name="isAllowOpenBox" id="is_allow_open_box_1"
                                   <#if entity.isAllowOpenBox?? && entity.isAllowOpenBox == 1>checked</#if> value="1" readonly/><label for="is_allow_open_box_1">启用</label>
                        </span>
                            <span class="radio_box">
                            <input type="radio" class="radio" name="isAllowOpenBox" id="is_allow_open_box_0"
                                   <#if entity.isAllowOpenBox?? && entity.isAllowOpenBox == 0>checked</#if> value="0" readonly/><label for="is_allow_open_box_0">禁用</label>
                        </span>
                        </td>
                    </tr>
                    <tr>
