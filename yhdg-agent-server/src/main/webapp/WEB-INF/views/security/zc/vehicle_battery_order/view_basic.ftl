        ...
        <form>
            ...
            <table cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td><input id="duration" class="text easyui-validatebox" readonly name="id" value="${(entity.id)!''}" style="width:182px;height:28px " ></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input id="duration" class="text easyui-validatebox" readonly name="putCabinetName" value="${(entity.putCabinetName)!''}" style="width:182px;height:28px " required="required" ></td>
                    <td align="right">放电箱号：</td>
                    <td><input id="duration" class="text easyui-validatebox" readonly name="putBoxNum" value="${(entity.putBoxNum)!''}" style="width:182px;height:28px " required="required" ></td>
                </tr>
                <tr>
                    <td align="right">当前电量：</td>
                    <td><input id="duration" class="text easyui-validatebox" readonly name="currentVolume" value="${(entity.currentVolume)!''}" style="width:182px;height:28px " required="required" ></td>
                    <td align="right">放电时间：</td>
                    <td>
                ...
                <tr>
                    <td align="right">当前电池容量：</td>
                    <td><input id="duration" class="text easyui-validatebox" readonly name="currentCapacity" value="${(entity.currentCapacity)!0}mAh" style="width:182px;height:28px " ></td>
                    <td align="right">取出电池容量：</td>
                    <td>
                        <input type="text" class="text easyui-validatebox" readonly name="initCapacity" value="${(entity.initCapacity)!0}mAh" style="width:182px;height:28px ">
                    </td>
                </tr>
                <tr>
                    <td align="right">支付类型：</td>
                    <td>
                        <select class="easyui-combobox" required="true" readonly  name="payType" style="width:192px;height:28px ">
                    ...
                    <td><input class="text easyui-validatebox" name="money" readonly  value="<#if (entity.money)??>${((entity.money) / 100 + "元")!''}<#else></#if>" style="width:182px;height:28px " required="required" ></td>
                </tr>
                <tr>
                    <td align="right">骑行距离：</td>
                    <td><input id="duration" class="text easyui-validatebox" readonly name="currentDistance" value="${(entity.currentDistance)!''}" style="width:182px;height:28px " required="required" ></td>
