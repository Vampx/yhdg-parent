    ...
    <script>
        $(function() {
            $('#page_table').datagrid({
                ...
                striped: true,
                pagination: true,
                url: "${contextPath}/security/zc/vehicle_rent_period_order/page.htm?agentId=${Session['SESSION_KEY_USER'].agentId}",
                fitColumns: true,
                pageSize: 50,
                pageList: [50, 100],
                idField: 'id',
                    ...
                    [
                        ...
                        },
                        {
                            ...
                            formatter: function(val, row) {
                                var html = '';
                                <@app.has_oper perm_code='zc.VehicleRentPeriodOrder:view'>
        ...
        function view(id) {
            App.dialog.show({
                ...
                title: '查看',
                href: "${contextPath}/security/zc/vehicle_rent_period_order/view.htm?id=" + id
        ...
        function editExtendRent(id) {
            App.dialog.show({
                ...
                title: '延长租期',
                href: "${contextPath}/security/zc/vehicle_rent_period_order/edit_extend_rent.htm?id=" + id,
                event: {
                    onClose: function() {
                        reload();
                    }
