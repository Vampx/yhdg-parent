        ...
        <form>
            <table cellpadding="0" cellspacing="0" style="width: 80%;">
                ...
                <tr>
                    ...
                    <td>
                        <input name="partnerId" id="partner_id" readonly style="height: 28px;width: 183px;" class="easyui-combobox"  editable="false"
                           ...
                           $('#partner_id').combobox('setValue', '${(entity.partnerId)!''}');
                       }"
                        />
                    </td>
                </tr>
