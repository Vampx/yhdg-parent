<div class="popup_body clearfix">
    ...
    <table cellpadding="0" cellspacing="0">
        <tr>
            ...
            <td>
                <input name="groupId" id="group_id_${pid}" class="easyui-combotree" editable="false" disabled style="width: 184px; height: 28px;" url="${contextPath}/security/yms/material_group/tree.htm?agentId=${(Session['SESSION_KEY_USER'].agentId)!''}" value="${(entity.groupId)!''}">
            </td>
            <td width="80" align="right">运营商名称：</td>
            <td>
                <input name="agentId" id="agent_id_${pid}" class="easyui-combotree" editable="false" <#if (entity.agentId)??>disabled</#if> style="width: 184px; height: 28px;" url="${contextPath}/security/basic/agent/tree.htm?dummy=${'无'?url}" value="${(entity.agentId)!''}">
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <select class="easyui-combobox" required="true" name="convertStatus" style="width:180px;height: 30px ">
