        ...
        <form method="post">
            ...
            <table cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td>
                        <input name="agentId" id="agent_id_${pid}" class="easyui-combotree" required="true"
                               style="width: 184px; height: 28px;" value="${Session['SESSION_KEY_USER'].agentId}" disabled
                ...
                <tr>
                    ...
                    <td><input type="text" class="text easyui-validatebox" required="true" maxlength="11" name="mobile" value="" style="width: 174px;height: 28px;"/></td>
                </tr>
                <tr>
