        ...
        <form>
            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td><input type="text"  maxlength="3" class="easyui-numberspinner" id="platform_ratio_${pid}" style="height: 28px;width: 185px;" name="platformRatio" disabled required="true"  data-options="min:0,max:100" value="${(entity.platformRatio)!''}"/></td>
                </tr>
                <tr>
