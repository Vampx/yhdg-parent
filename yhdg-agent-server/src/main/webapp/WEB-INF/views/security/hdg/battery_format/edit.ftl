        ...
        <form>
            ...
            <table cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td align="right">
                        <input type="text" class="text easyui-validatebox"  maxlength="40" name="cellModel" value="${(entity.cellModel)!''}"/>
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="3">
                        <input type="text" class="text easyui-validatebox" placeholder="两位大写字母组成" value="${(entity.barcodeRule)!''}"  maxlength="2" name="barcodeRule" required="true" readonly/>
                    </td>
                </tr>
                <tr>
