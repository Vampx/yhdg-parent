                ...
                <#if editFlag?? && (editFlag==1)>
                    {
                        ...
                        width: 80,
                        formatter: function (val, row) {
                            return '<#if editFlag?? && (editFlag==1)><a href="javascript:edit_box_record(\'SUBCABINET_ID\', \'BOX_NUM\')">修改</a>  <a href="javascript:delete_box_record(\'SUBCABINET_ID\', \'BOX_NUM\')">删除</a></#if>  <a href="javascript:open_box(\'SUBCABINET_ID\', \'BOX_NUM\')">开箱</a>'.replace(/SUBCABINET_ID/g, row.cabinetId).replace(/BOX_NUM/g, row.boxNum);
                        }
                    }
                </#if>
                ]
