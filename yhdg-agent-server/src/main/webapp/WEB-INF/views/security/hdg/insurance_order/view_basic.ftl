...
<#--                    <td align="right">赠送余额：</td>-->
<#--                    <td><input class="text easyui-validatebox" readonly value="${((entity.consumeGiftBalance) / 100 + "元")!''}" style="width:182px;height:28px " required="required" ></td>-->
<#--                </tr>-->
<#--                <tr>-->
