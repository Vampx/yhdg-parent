    ...
    $(function() {
        ...
        $(".insurance_rent_add").click(function () {
            App.dialog.show({
                ...
                title: '添加保险',
                href: "${contextPath}/security/hdg/insurance/exchange_insurance_add.htm?batteryType="+ ${(entity.batteryType)!''}+ "&agentId="+ ${(entity.agentId)!''},
                windowData:{
                },
                event: {
                }
        ...
        $(".insurance_rent .fa-edit").click(function () {
            var insuranceId = $(this).attr("insurance_rent_id");
            App.dialog.show({
                css: 'width:500px;height:500px;overflow:visible;',
                title: '修改保险',
                href: "${contextPath}/security/hdg/insurance/exchange_insurance_edit.htm?insuranceId=" + insuranceId,
                windowData:{
                },
                event: {
                }
        ...
        $(".insurance_rent .fa-close").click(function () {
            ...
            $.messager.confirm('提示信息', '删除保险设置将删除对应的分期设置，确认删除?', function (ok) {
                if (ok) {
                    $.post("${contextPath}/security/hdg/insurance/exchange_insurance_delete.htm?insuranceId=" + insuranceId, function (json) {
                        if (json.success) {
