                ...
                <form method="post">
                    <table cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <td>
                                <input type="text" class="easyui-numberspinner" style="width: 184px; height: 28px;" name="foregiftMoney" value="0" maxlength="20"/>
                            </td>
                        </tr>
                        <tr>
                            <td align="right">租金金额：</td>
                            <td><input type="text" class="easyui-numberspinner" style="width: 184px; height: 28px;" name="rentMoney" maxlength="20"
                                       value="0"/></td>
                            <td width="70" align="right">租金周期(月)：</td>
                            <td><input type="text" class="text easyui-numberspinner" data-options="min:0" maxlength="20" name="periodType"
                                       style="width: 184px; height: 28px;" value="0"/></td>
                        </tr>
