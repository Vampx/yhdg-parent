                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input name="batteryType" id="page_battery_type" class="easyui-combotree" editable="false"
                                               ...
                                               data-options="url:'${contextPath}/security/basic/agent_battery_type/tree.htm?agentId=${Session['SESSION_KEY_USER'].agentId}',
                                method:'get',
                                valueField:'id',
                                textField:'text',
                                editable:false,
    ...
    (function () {
        ...
        win.find('button.ok').click(function () {
            ...
            if(success) {
                ...
                $.post('${contextPath}/security/hdg/exchange_installment_setting/create.htm', {
                    data : $.toJSON(values)
                }, function(json) {
                <@app.json_jump/>
                    if(json.success) {
