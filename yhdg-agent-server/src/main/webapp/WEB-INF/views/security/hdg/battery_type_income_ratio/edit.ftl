        ...
        <form>
            ...
            <table cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td>
                        <input name="agentId" readonly id="agent_id_${pid}" class="easyui-combotree" required="true"
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="text easyui-validatebox" maxlength="3" name="platformRatio" value="${(entity.platformRatio)!''}" required/>
                    </td>
                    <td width="80" align="right">运营商比例：</td>
                    <td>
                        <input type="text" class="text easyui-validatebox" maxlength="3" name="agentRatio" value="${(entity.agentRatio)!''}" required/>
                    </td>
                </tr>
                <tr>
                    <td width="80" align="right">省代比例：</td>
                    <td>
                        <input type="text" class="text easyui-validatebox" maxlength="3" name="provinceAgentRatio" value="${(entity.provinceAgentRatio)!''}" required/>
                    </td>
                    <td width="80" align="right">市代比例：</td>
                    <td>
                        <input type="text" class="text easyui-validatebox" maxlength="3" name="cityAgentRatio" value="${(entity.cityAgentRatio)!''}" required/>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input type="text" class="text easyui-validatebox" maxlength="3" name="platformDeductMoney" value="${(entity.platformDeductMoney)!''}" required/>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="text easyui-validatebox" maxlength="3" name="rentPeriodMoney" value="${(entity.rentPeriodMoney)!''}"/>
                    </td>
