                    ...
                    <tr>
                        ...
                        <td>
                            <input name="agentId" id="agent_id_${pid}" class="easyui-combotree" required="true"
                                   editable="false" style="width: 255px; height: 28px;" disabled value="${(agentId)!''}"
...
<script>
    ...
    (function () {
        ...
        win.find('button.shop_ok').click(function () {
            ...
            form.form('submit', {
                url: '${contextPath}/security/hdg/shop/create.htm',
    ...
    function getLocation() {
        App.dialog.show({
            ...
            title: '地图定位',
            href: "${contextPath}/security/hdg/shop/add_location.htm",
            windowData: {
                ok: function(config) {
                    var win = $('#${pid}');
