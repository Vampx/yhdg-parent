    ...
    <script>
        $(function () {
            $('#page_table').datagrid({
                ...
                striped: true,
                pagination: true,
                url: "${contextPath}/security/hdg/agent_material_day_stats/page.htm?agentId=${Session['SESSION_KEY_USER'].agentId}",
                fitColumns: true,
                pageSize: 50,
                pageList: [50, 100],
                idField: 'id',
            ...
            <div class="content">
                ...
                <div class="panel grid_wrap">
                    <div class="toolbar clearfix">
                        <div class="float_right">
                            <@app.has_oper perm_code='hdg.AgentMaterialDayStats:payMoney'>
                                <button class="btn btn_green" onclick="pay_money()">支付</button>
                            </@app.has_oper>
                            <@app.has_oper perm_code='hdg.AgentMaterialDayStats:exportExcel'>
