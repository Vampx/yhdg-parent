        ...
        <form>
            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td>
                    <#if entity.status == 2>
                        <input type="radio" value="2" checked disabled>通过&nbsp;&nbsp;
                        <input type="radio" value="3" disabled>未通过
                    <#elseif entity.status == 3>
                        <input type="radio" value="2" disabled>通过&nbsp;&nbsp;
                        <input type="radio" value="3" checked disabled>未通过
                    </#if>
                    </td>
                </tr>
            </table>
