        ...
        <form>
            ...
            <table cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td>
                        <input type="text" class="easyui-numberspinner" style="width: 184px; height: 28px;" name="foregiftMoney" value="${(entity.foregiftMoney) !'0'}" maxlength="20"/>
                    </td>
                </tr>
                <tr>
                    <td align="right">租金金额：</td>
                    <td><input type="text" class="easyui-numberspinner" style="width: 184px; height: 28px;" name="rentMoney" maxlength="10"
...
<script>
    ...
    (function() {
        ...
        win.find('button.ok').click(function() {
            form.form('submit', {
                url: '${contextPath}/security/hdg/cabinet_install_record/update_upline.htm',
