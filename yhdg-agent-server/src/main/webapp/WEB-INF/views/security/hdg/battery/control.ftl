    ...
    <script>
        $(function() {
            $('#page_table').datagrid({
                ...
                striped: true,
                pagination: true,
                url: "${contextPath}/security/hdg/battery/battery_control_page.htm",
                fitColumns: true,
                pageSize: 10,
                pageList: [10, 50, 100],
                idField: 'id',
        ...
        function view(id) {
            App.dialog.show({
                ...
                title: '查看',
                href: "${contextPath}/security/hdg/battery/view_control.htm?id=" + id
            });
        }
        ...
        function viewBatteryTrack(id) {
            App.dialog.show({
                ...
                title: '电池监控',
                href: "${contextPath}/security/hdg/battery/view_battery_track.htm?id=" + id,
                event: {
                    onClose: function() {
                        reload();
                    }
