        ...
        <form method="post">
            <table cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td>
                        <input name="agentId" required="true" id="agent_id_${pid}" class="easyui-combotree" editable="false" style="width: 184px; height: 28px;" disabled value="${Session['SESSION_KEY_USER'].agentId}"
                ...
                <tr>
                    ...
                    <td>
                        <input id="battery_type_${pid}" name="batteryType" class="easyui-combotree" editable="false"
                               style="width: 184px; height: 28px;"
                               url="${contextPath}/security/basic/agent_battery_type/tree.htm?agentId=${Session['SESSION_KEY_USER'].agentId}">
                    </td>
...
<script>
    ...
    (function() {
        ...
        win.find('button.ok').click(function() {
            ...
            form.form('submit', {
                url: '${contextPath}/security/hdg/packet_period_activity/create.htm',
