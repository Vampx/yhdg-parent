        ...
        <form method="post">
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td><input class="easyui-numberspinner" required="true" id="paid_${pid}" maxlength="5" style="width:184px;height: 28px;" data-options="min:0.01,precision:2"></td>
                </tr>
                <tr>
                    ...
                    <td><input type="text" class="text easyui-numberspinner" required="true" id="month_count_${pid}" name="monthCount" maxlength="3"
                               data-options="min:0, max:12" style="width: 184px; height: 28px;"/></td>
                </tr>
                <tr>
...
<script>
    ...
    (function() {
        ...
        win.find('button.ok').click(function() {
            ...
            form.form('submit', {
                url: '${contextPath}/security/hdg/insurance/exchange_insurance_create.htm',
