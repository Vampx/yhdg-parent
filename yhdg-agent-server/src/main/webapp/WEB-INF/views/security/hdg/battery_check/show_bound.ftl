...
<script>
    ...
    function toBindCell() {
        ...
        App.dialog.show({
            ...
            title: '绑定电芯',
            href: "${contextPath}/security/hdg/battery_cell/bind.htm?batteryFormatId=" + batteryFormatId + "&batteryId=" + batteryId + "&cellMfr=" + cellMfr + "&cellModel=" + cellModel + "&shellCode=" + batteryBarcode + "&code=" + batteryCode  + "&appearance=" + appearance,
            windowData:{
