        ...
        <div class="ui_table">
            <form method="post">
                <table cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td>
                            <input name="agentId" id="agent_id_${pid}" class="easyui-combotree" required="true"
                                   editable="false" style="width: 190px; height: 28px;" value="${Session['SESSION_KEY_USER'].agentId}"
                    ...
                    <tr>
                        <td width="60" align="left">所属物业：</td>
                        <td>
                    ...
                    <tr>
                        <td width="80" align="left">物业账号：</td>
                    ...
                    <#--<tr>-->
                        ...
                        <#--<td>-->
                            <#--<input class="easyui-combobox" name="estateRoleId" id="estate_role_id_${pid}"-->
                                   ...
                                   <#--data-options="url:'${contextPath}/security/basic/estate_role/find_all.htm',-->
                                                <#--method:'get',-->
                                                <#--valueField:'id',-->
                                                <#--textField:'text',-->
                                                <#--editable:false,-->
...
<script>
    function swich_agent_${pid}() {
        ...
        var estateComboTree = $('#estate_id_${pid}');
    ...
    <#--function switch_estate_${pid}() {-->
        ...
        <#--var roleCombobox = $('#estate_role_id_${pid}');-->
        <#--roleCombobox.combobox({-->
            <#--url: "${contextPath}/security/basic/estate_role/find_all.htm?estaeId=" + estateId + ""-->
        <#--});-->
        <#--roleCombobox.combobox('reload');-->
    <#--}-->
    ...
    (function () {
        ...
        win.find('button.ok').click(function () {
            $.messager.confirm('提示信息', '确定新建?', function (ok) {
                if (ok) {
                    form.form('submit', {
                        url: '${contextPath}/security/hdg/estate_user/create.htm',
