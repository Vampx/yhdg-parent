        ...
        <form method="post">
            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td><input id="price_${pid}" class="easyui-numberspinner"   style="width:180px;height: 30px " required="required" data-options="min:0.01,precision:2">&nbsp;&nbsp;元</td>
                </tr>
            </table>
        </form>
    </div>
...
<script>
    ...
    (function() {
        ...
        win.find('button.ok').click(function() {
            form.form('submit', {
                url: '${contextPath}/security/hdg/packet_price_detail/create.htm',
