    ...
    <div class="search" style="margin:0 0; padding:2px 0 0 0; border-bottom:none;">
        <table cellspacing="0" cellpadding="0" border="0">
            <tr>
                ...
                <td><input type="text" style="width: 100px" class="text" id="barcode_code_${pid}"/>&nbsp;&nbsp;</td>
                <td>
...
<script>
    ...
    (function() {
        ...
        datagrid.datagrid({
            ...
            striped: true,
            pagination: true,
            url: "${contextPath}/security/hdg/battery_cell_barcode/page.htm?cellFormatId=${(id)!''}",
            fitColumns: true,
            pageSize: 10,
            pageList: [10, 50, 100],
            idField: 'id',
        ...
        var exportExcel = function(){
            window.location.href = "${contextPath}/security/hdg/battery_cell_barcode/export_excel.htm?cellFormatId=${(id)!''}";
        };
