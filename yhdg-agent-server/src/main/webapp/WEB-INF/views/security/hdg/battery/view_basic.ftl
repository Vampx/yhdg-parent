        ...
        <form>
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" editable="false" readonly class="text easyui-datetimebox"  value="${(entity.upLineTime?string('yyyy-MM-dd HH:mm:ss'))!''}" style="width: 183px; height: 28px;"/>
                    </td>
                </tr>
            </table>
        </form>
