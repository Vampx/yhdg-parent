    ...
    <script>
        $(function () {
            $('#page_table').datagrid({
                ...
                collapsible: true,
                pagination: true,
                url: "${contextPath}/security/hdg/cabinet_month_stats/page.htm?agentId=${Session['SESSION_KEY_USER'].agentId}",
                pageSize: 50,
                pageList: [50, 100],
                idField: 'id',
                frozenColumns: [[
                    {title: '统计日期', align: 'center', field: 'statsMonth', width: 80},
                    {title: '运营商名称', align: 'center', field: 'agentName', width: 80},
                    {title: '换电柜编号', align: 'center', field: 'cabinetId', width: 80},
                    {title: '换电柜名称', align: 'center', field: 'cabinetName', width: 80}
                ]],
                columns: [
                    [
                        {
        ...
        function exportExcel() {
            $.messager.confirm('提示信息', '确认导出数据?', function (ok) {
                if (ok) {
                    ...
                    $.messager.progress();
                    $.post('${contextPath}/security/hdg/cabinet_month_stats/export_excel.htm', {
                        ...
                        if (json.success) {
                            document.location.href = '${contextPath}/security/hdg/cabinet_month_stats/download.htm?filePath=' + json.data;
                        } else {
            ...
            <div class="content">
                <div class="panel search">
                    ...
                    <table cellpadding="0" cellspacing="0" border="0">
                        <tr>
                            <td align="right" width="80px;">换电柜编号：</td>
                            <td><input type="text" class="text" id="cabinet_id"/>&nbsp;&nbsp;</td>
                            <td align="right" width="80px;">换电柜名称：</td>
                ...
                <div class="panel grid_wrap" style="top: 80px">
                    <div class="toolbar clearfix">
                        <div class="float_right">
                            <@app.has_oper perm_code='hdg.CabinetMonthStats:exportExcel'>
