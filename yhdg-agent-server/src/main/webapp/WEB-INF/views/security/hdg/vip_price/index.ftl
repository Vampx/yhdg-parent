    ...
    <script>
        $(function() {
            $('#page_table').datagrid({
                ...
                striped: true,
                pagination: true,
                url: "${contextPath}/security/hdg/vip_price/page.htm?agentId=${Session['SESSION_KEY_USER'].agentId}",
                fitColumns: true,
                pageSize: 10,
                pageList: [10, 50, 100],
                idField: 'id',
        ...
        function add() {
            App.dialog.show({
                ...
                title: '新建',
                href: "${contextPath}/security/hdg/vip_price/add.htm",
                windowData:{
                    ok:function (id) {
                        edit(id);
                    }
        ...
        function edit(id) {
            App.dialog.show({
                ...
                title: '修改',
                href: "${contextPath}/security/hdg/vip_price/edit.htm?id=" + id ,
                event: {
                    onClose: function() {
                        query();
                    },
