    ...
    <script>
        $(function () {
            $('#page_table').datagrid({
                ...
                striped: true,
                pagination: true,
                url: "${contextPath}/security/hdg/battery_order/page.htm?agentId=${Session['SESSION_KEY_USER'].agentId}",
                fitColumns: true,
                pageSize: 50,
                pageList: [50, 100],
                idField: 'id',
                ...
                columns: [
                    [
                        ...
                        },
                        {
                            ...
                            width: 40,
                            formatter: function (val, row) {
                                return '' + (row.initCapacity ==null?0:row.initCapacity) + ' -> ' + (row.currentCapacity ==null?0:row.currentCapacity) + '';
                            }
                        },
                        {
                            title: '骑行里程',
