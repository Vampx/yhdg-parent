    ...
    <script>
        $(function () {
            $('#page_table').datagrid({
                ...
                collapsible: true,
                pagination: true,
                url: "${contextPath}/security/hdg/shop_day_stats/page.htm?agentId=${Session['SESSION_KEY_USER'].agentId}",
                pageSize: 50,
                pageList: [50, 100],
                idField: 'id',
                frozenColumns: [[
                    {title: '统计日期', align: 'center', field: 'statsDate', width: 120},
                    {title: '门店名称', align: 'center', field: 'shopName', width: 120}
                ]],
                columns: [
                    [
                        {
        ...
        function exportExcel() {
            $.messager.confirm('提示信息', '确认导出数据?', function (ok) {
                if (ok) {
                    ...
                    var statsDate = $('#stats_date').datebox('getValue');
                    $.messager.progress();
                    $.post('${contextPath}/security/hdg/shop_day_stats/export_excel.htm', {
                        agentId: agentId,
                        statsDate: statsDate,
                        agentName: agentName
                    }, function (json) {
                        ...
                        if (json.success) {
                            document.location.href = '${contextPath}/security/hdg/shop_day_stats/download.htm?filePath=' + json.data;
                        } else {
            ...
            <div class="content">
                <div class="panel search">
                    ...
                    <table cellpadding="0" cellspacing="0" border="0">
                        <tr>
                            <td align="right" width="80">门店名称：</td>
                            <td><input type="text" class="text" id="shop_name"/>&nbsp;&nbsp;</td>
                            <td align="right">日期：</td>
                            <td><input type="text" class="easyui-datebox" id="stats_date" style="width: 144px;height: 26px;"/>&nbsp;&nbsp;
                            </td>
                ...
                <div class="panel grid_wrap" style="top: 80px">
                    <div class="toolbar clearfix">
                        <div class="float_right">
                            <@app.has_oper perm_code='hdg.ShopDayStats:exportExcel'>
