        ...
        <div class="ui_table">
            <form method="post">
                <table cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td>
                            <input name="agentId" id="agent_id_${pid}" class="easyui-combotree" required="true"
                                   editable="false" style="width: 190px; height: 28px;" value="${Session['SESSION_KEY_USER'].agentId}" disabled
                    ...
                    <tr>
                        <td width="80" align="left">门店账号：</td>
                    ...
                    <tr>
                        ...
                        <td>
                            <input class="easyui-combobox" name="shopRoleId" id="shop_role_id_${pid}"
                                   ...
                                   data-options="url:'${contextPath}/security/basic/shop_role/find_all.htm',
                                                method:'get',
                                                valueField:'id',
                                                textField:'text',
                                                editable:false,
    ...
    (function () {
        ...
        win.find('button.ok').click(function () {
            $.messager.confirm('提示信息', '确定新建?', function (ok) {
                if (ok) {
                    form.form('submit', {
                        url: '${contextPath}/security/hdg/shop_user/create.htm',
