<div class="popup_body">
    <div class="ui_table">
        <form method="post">
            ...
            <input type="hidden" name="foregiftId" value="${(entity.foregiftId)!''}">
            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td><input type="text" class="easyui-numberbox" name="limitCount" id="limit_count_${pid}" style="width: 185px;height: 28px;"
                               maxlength="4" data-options="min:0" value="${(entity.limitCount)!''}"/></td>
                </tr>
                <tr>
                    ...
                    <td><input type="text" class="easyui-numberbox" name="dayLimitCount" id="day_Limit_count_${pid}" style="width: 185px;height: 28px;"
                               maxlength="4" data-options="min:0" value="${(entity.dayLimitCount)!''}"/></td>
                </tr>
                <tr>
    ...
    (function() {
        ...
        win.find('button.ok').click(function() {
            ...
            if(lastPrice == nextPrice) {
                form.form('submit', {
                    url: '${contextPath}/security/hdg/packet_period_price/exchange_packet_period_price_update.htm',
