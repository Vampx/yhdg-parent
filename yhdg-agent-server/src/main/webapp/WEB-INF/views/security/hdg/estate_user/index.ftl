    ...
    <script>
        ...
        $(function () {
            $('#page_table').datagrid({
                ...
                striped: true,
                pagination: true,
                url: "${contextPath}/security/basic/user/estate_user_page.htm?agentId=${Session['SESSION_KEY_USER'].agentId}&estateFlag=1",
                fitColumns: true,
                pageSize: 10,
                pageList: [10, 50, 100],
                idField: 'id',
...
//                        {title: '角色', align: 'center', field: 'estateRoleName', width: 60},
                        {
                            title: '是否启用',
                            align: 'center',
                            field: 'isActive',
                        ...
                        },
                        {
                            ...
                            formatter: function (val, row) {
                                var html = '';
                                <@app.has_oper perm_code='hdg.estateUser:view'>
                                    html += '<a href="javascript:view(ID)">查看</a>';
                                </@app.has_oper>
                                <@app.has_oper perm_code='hdg.estateUser:edit'>
                                    html += ' <a href="javascript:edit(ID)">修改</a>';
                                </@app.has_oper>
                                <@app.has_oper perm_code='hdg.estateUser:remove'>
        ...
        function query() {
            ...
            datagrid.datagrid('options').queryParams = {
                ...
                estateId: $('#estate_id').combotree('getValue')
            };
                ...
                success: function (text) {
                    ...
                    if (!json.success) {
                        ...
                        App.dialog.show({
                            ...
                            title: '新建',
                            href: "${contextPath}/security/hdg/estate_user/add.htm?agentId=${Session['SESSION_KEY_USER'].agentId}",
                            event: {
                                onClose: function () {
                                    reload();
                                }
        ...
        function edit(id) {
            App.dialog.show({
                css: 'width:665px;height:485px;overflow:visible;',
                title: '修改',
                href: "${contextPath}/security/hdg/estate_user/edit.htm?id=" + id,
                event: {
                    onClose: function () {
                        var datagrid = $('#page_table');
                        datagrid.datagrid('reload');
        ...
        function view(id) {
            App.dialog.show({
                css: 'width:665px;height:485px;overflow:visible;',
                title: '查看',
                href: "${contextPath}/security/hdg/estate_user/view.htm?id=" + id
            });
        }
            ...
            <div class="content">
                <div class="panel search">
                    ...
                    <table cellpadding="0" cellspacing="0" border="0">
                        <tr>
                            <td width="60" align="right">物业：</td>
                            <td>
                                <input id="estate_id" class="easyui-combotree" editable="false"
