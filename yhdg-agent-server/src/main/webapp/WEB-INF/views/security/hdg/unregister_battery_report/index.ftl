    ...
    <script>
        ...
        function view(code,createTime) {
            App.dialog.show({
                ...
                title: '查看',
                href: "${contextPath}/security/hdg/unregister_battery_report/view.htm?code=" + code +"&createTime=" + createTime
            });
        }
        ...
        function query(){
            ...
            datagrid.datagrid('options').url = "${contextPath}/security/hdg/unregister_battery_report/page.htm";
