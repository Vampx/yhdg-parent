    ...
    <script>
        ...
        $(function() {
            $('#page_table').datagrid({
                ...
                striped: true,
                pagination: true,
                url: "${contextPath}/security/hdg/exchange_installment_setting/page.htm?agentId=${Session['SESSION_KEY_USER'].agentId}",
                fitColumns: true,
                pageSize: 10,
                pageList: [10, 50, 100],
                idField: 'id',
                    ...
                    [
                        ...
                        {title: '创建时间', align: 'center', field: 'createTime', width: 60},
                        {
                            ...
                            formatter: function(val, row) {
                                ...
                                <#--<@app.has_oper perm_code='hdg.ExchangeInstallmentSetting:detail'>-->
        ...
        function add() {
            App.dialog.show({
                ...
                title: '新建',
                href: "${contextPath}/security/hdg/exchange_installment_setting/add.htm",
                event: {
                    onClose: function() {
                        query();
                    }
