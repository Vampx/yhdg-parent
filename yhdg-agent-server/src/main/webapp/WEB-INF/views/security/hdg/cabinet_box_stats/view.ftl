...
<script>
    (function () {
        $('#page_table_box_${pid}').datagrid({
            fit: true,
            url: "${contextPath}/security/hdg/cabinet_box_stats/stats_page.htm?cabinetId=${cabinetId}&viewFlag=${viewFlag}",
            fitColumns: true,
            pagination: false,
            idField: 'cabinetId',
            columns: [
                [
                    {title: '分柜编号', align: 'center', field: 'subcabinetId', width: 40},
