        ...
        <form>
            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td>
                        <select class="easyui-combobox" required="true"  name="type" style="width:195px;height:28px ">
                ...
                <tr>
                    ...
                    <td>
                        <select class="easyui-combobox" required="true"  name="status" style="width:195px;height:28px ">
