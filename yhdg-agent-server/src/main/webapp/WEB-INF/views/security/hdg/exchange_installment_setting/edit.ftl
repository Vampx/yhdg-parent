<div class="popup_body" style="padding-left:10px;padding-top: 20px;font-size: 14px;min-height: 85%;">
    <div class="ui_table">
        <form method="post">
                        ...
                        <td width="500px;">
                            <table>
                                <tr>
                                    ...
                                    <td id="exchange_battery_foregift">
                                    <#include 'edit_exchange_battery_foregift.ftl'>
                                    </td>
                                </tr>
                                <tr>
                                    <td>电池租金：</td>
                                    <td id="exchange_packet_period_price">
                                    <#include 'edit_exchange_packet_period_price.ftl'>
                                    </td>
                                </tr>
                                <tr>
                                    <td>电池保险：</td>
                                    <td id="exchange_insurance">
                                    <#include 'edit_exchange_insurance.ftl'>
                                    </td>
                                </tr>
                            </table>
                        </td>
            ...
            <#if exchangeInstallmentDetailList ??>
                <#list exchangeInstallmentDetailList as detail>
...
<script>
    ...
    function switch_battery_type_${pid}() {
        ...
        if (batteryType != null && agentId != null) {
            //获取套餐信息
            $.post("${contextPath}/security/hdg/exchange_installment_setting/find_price_info.htm?" + "batteryType=" + batteryType +"&agentId=" + agentId, function (json) {
                if (json.success) {
                    var data = json.data;
    ...
    function view_pay_detail(num) {
        App.dialog.show({
            ...
            title: '支付详情',
            href: "${contextPath}/security/hdg/exchange_installment_setting/view_pay_detail.htm?settingId=${(entity.id)!''}" + "&num=" + num
        });
    }
    ...
    (function () {
        ...
        //押金
        $.post('${contextPath}/security/hdg/exchange_installment_setting/edit_exchange_battery_foregift.htm', {
            foregiftId: $('#foregift_id').val(),
            batteryType: batteryType,
            agentId: agentId,
        }, function (html) {
        ...
        //换电包时段套餐
        $.post('${contextPath}/security/hdg/exchange_installment_setting/edit_exchange_packet_period_price.htm', {
            foregiftId: $('#foregift_id').val(),
        ...
        //保险
        $.post('${contextPath}/security/hdg/exchange_installment_setting/edit_exchange_insurance.htm', {
        ...
        win.find('button.ok').click(function () {
            ...
            if(success) {
                ...
                $.post('${contextPath}/security/hdg/exchange_installment_setting/update.htm', {
                    data : $.toJSON(values)
                }, function(json) {
                <@app.json_jump/>
                    if(json.success) {
