...
//                        },
                        {
                            ...
                            formatter: function(val, row) {
                                var html = '';
                                <@app.has_oper perm_code='9_2_1_3'>
                                    html += '<a href="javascript:view(ID)">查看</a>';
                                </@app.has_oper>
                                <@app.has_oper perm_code='9_2_1_4'>
                                    html += ' <a href="javascript:edit(ID)">修改</a>';
                                </@app.has_oper>
                                <@app.has_oper perm_code='9_2_1_5'>
        ...
        function add() {
            App.dialog.show({
                css: 'width:550px;height:625px;overflow:visible;',
                title: '新建',
                ...
                <div class="content">
                    ...
                    <div class="panel grid_wrap">
                        <div class="toolbar clearfix">
                            <div class="float_right">
                                <@app.has_oper perm_code='9_2_1_2'>
