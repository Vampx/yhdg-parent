        ...
        <div class="ui_table">
            <form method="post">
                <table cellpadding="0" cellspacing="0">
                    <tr>
                        <td width="90" align="right">优惠券类型：</td>
                        <td>
                    ...
                    <tr>
                        <td width="90" align="right">优惠券名称：</td>
                    ...
                    <tr>
                        <td width="90" align="right">优惠券金额：</td>
                        <td><input id="money_${pid}" readonly="readonly" class="easyui-numberspinner" value="${((entity.money)/ 100 + "元")!''}"  style="width:180px;height: 30px " required="required" data-options="min:0.01,precision:2">&nbsp;&nbsp;元</td>
                    </tr>
                    <tr>
