                ...
                <tr>
                    ...
                    <td>
                        <div style="width:330px; height:150px; padding:5px; border:1px solid #ddd; overflow:auto;">
                            <ul id="oper_tree" class="easyui-tree" url="${contextPath}/security/basic/role/tree.htm" checkbox="true" cascadeCheck="true" lines="true"></ul>
                        </div>
                    </td>
                </tr>
            </table>
...
<script>
    function changeOperTree(node) {
        ...
        operTree.tree({
            url:"${contextPath}/security/basic/role/tree.htm?agentId=" + node.id
        });
        operTree.tree('reload');
    }
