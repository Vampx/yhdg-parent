...
<script>
    (function() {
        ...
        datagrid.datagrid({
            ...
            striped: true,
            pagination: true,
            url: "${contextPath}/security/basic/customer_active_whitelist/page_not_whitelist.htm",
            fitColumns: true,
            pageSize: 10,
            pageList: [10, 50, 100],
            idField: 'id',
    ...
    $('#ok_${pid}').click(function() {
        ...
        $(function (ok) {
            if (ok) {
                $.post('${contextPath}/security/basic/customer_active_whitelist/insert.htm', {
                    id: list
                }, function (json) {
                    if (json.success) {
