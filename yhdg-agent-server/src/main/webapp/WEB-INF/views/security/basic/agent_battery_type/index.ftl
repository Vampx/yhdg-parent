    ...
    <script>
        $(function () {
            $('#page_table').datagrid({
                ...
                striped: true,
                pagination: true,
                url: "${contextPath}/security/basic/agent_battery_type/page.htm?agentId=${Session['SESSION_KEY_USER'].agentId}",
                fitColumns: true,
                pageSize: 50,
                pageList: [50, 100],
                idField: 'id',
                    ...
                    [
                        ...
                        },
                        {
                            ...
                            formatter: function (val, row) {
                                ...
                                <@app.has_oper perm_code='basic.AgentBatteryType:delete'>
        ...
        function add() {
            App.dialog.show({
                css: 'width:400px;height:270px;',
                title: '新建',
                href: "${contextPath}/security/basic/agent_battery_type/add.htm",
                windowData:{
        ...
        function edit(batteryType,agentId,editFlag) {
            App.dialog.show({
                css: 'width:786px;height:540px;overflow:visible;',
                title: '修改',
                href: "${contextPath}/security/basic/agent_battery_type/edit.htm?batteryType=" + batteryType + "&agentId=" + agentId + "&editFlag=" + editFlag,
                event: {
                    onClose: function () {
                        reload();
                    },
        ...
        function view(batteryType,agentId) {
            App.dialog.show({
                css: 'width:500px;height:344px;',
                title: '查看',
                href: "${contextPath}/security/basic/agent_battery_type/view.htm?batteryType=" + batteryType + "&agentId=" + agentId
            });
        }
                ...
                <div class="panel search">
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" style="border-collapse:separate; border-spacing: 0px 3px;">
                        <tr>
                            ...
                            <td><input type="text" style="width:170px; height: 28px;" class="text" id="type_name"/></td>
                        </tr>
                    </table>
                </div>
