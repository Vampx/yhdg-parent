        ...
        <form >
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td><input type="text" class="text easyui-validatebox" required="true" name="operatorName" readonly value="${(entity.operatorName)!''}" maxlength="40"/></td>
                </tr>
                <tr>
                    <td width="70" align="right">数量：</td>
                    <td><input type="text" class="text easyui-validatebox" required="true" name="mobileCount" readonly value="${(entity.mobileCount)!''}" maxlength="40"/></td>
                </tr>
            </table>
        </form>
    </div>
