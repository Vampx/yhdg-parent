                ...
                <tr>
                    ...
                    <td>
                        <div style="width:330px; height:150px; padding:5px; border:1px solid #ddd; overflow:auto;">
                            <ul id="shop_app_tree" class="easyui-tree" url="${contextPath}/security/basic/shop_role/shop_app_tree.htm?id=${entity.id}&shopId=${(entity.shopId)!''}" checkbox="true" cascadeCheck="true" lines="true"></ul>
                        </div>
                    </td>
                </tr>
            </table>
...
<script>
    (function() {
        ...
        win.find('button.ok').click(function() {
            form.form('submit', {
                url: '${contextPath}/security/basic/shop_role/update.htm',
