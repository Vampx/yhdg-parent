        ...
        <form method="post">
            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td><input type="password" maxlength="40" class="text easyui-numberbox" name="password" id="password_${pid}" /></td>
                    <td align="right">确认密码：</td>
                    <td><input type="password"maxlength="40" class="text easyui-numberbox" name="password2" id="password2_${pid}" validType="equals['#password_${pid}']" /></td>
                </tr>
                <tr>
...
<script>
    ...
    (function() {
        ...
        win.find('button.ok').click(function() {
            ...
            form.form('submit', {
                url: '${contextPath}/security/basic/user_agent/update.htm',
