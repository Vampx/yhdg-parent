    ...
    <script>
        $(function () {
            $('#page_table').datagrid({
                ...
                striped: true,
                pagination: true,
                url: "${contextPath}/security/basic/customer_coupon_ticket_vehicle/page.htm?agentId=${Session['SESSION_KEY_USER'].agentId}",
                fitColumns: true,
                pageSize: 50,
                pageList: [50, 100],
                idField: 'id',
        ...
        function add() {
            App.dialog.show({
                css: 'width:850px;height:470px;overflow:visible;',
                title: '新建',
