        ...
        <form>
            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <#--<tr>-->
                    ...
                    <#--<td><input type="text" class="text easyui-validatebox"  value="${(entity.mpCode)!''}" style="width: 172px; height: 28px;"/></td>-->
                <#--</tr>-->
                <tr>
                    <td width="70" align="right">生活号：</td>
                    <td><input type="text" class="text easyui-validatebox" readonly  value="${(entity.fwCode)!''}" style="width: 172px; height: 28px;"/></td>
                </tr>
                <tr>
