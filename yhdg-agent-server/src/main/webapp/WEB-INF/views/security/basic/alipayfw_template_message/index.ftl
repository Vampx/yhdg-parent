    ...
    <script>
        $(function() {
            $('#page_table').datagrid({
                ...
                striped: true,
                pagination: true,
                url: "${contextPath}/security/basic/alipayfw_template_message/page.htm",
                fitColumns: true,
                pageSize: 50,
                pageList: [50, 100, 150],
                idField: 'id',
                    ...
                    [
                        ...
                        },
                        {
                            ...
                            formatter: function(val, row) {
                                var html = '';
                                <@app.has_oper perm_code='7_4_2_2'>
        ...
        function edit(id) {
            App.dialog.show({
                ...
                title: '修改',
                href: "${contextPath}/security/basic/alipayfw_template_message/edit.htm?id=" + id,
                event: {
                    onClose: function() {
                        var datagrid = $('#page_table');
                        datagrid.datagrid('reload');
        ...
        function view(id) {
            App.dialog.show({
                css: 'width:600px;height:530px;overflow:visible;',
                title: '查看',
