<script>
        (function () {
            ...
            datagrid.datagrid({
                ...
                striped: true,
                pagination: true,
                url: "${contextPath}/security/basic/customer_coupon_ticket_gift/binDingPage.htm",
                fitColumns: true,
                pageSize: 10,
                pageList: [10, 50, 100],
                idField: 'id',
        ...
        function add_riders_${pid}() {
            App.dialog.show({
                ...
                title: '添加骑手手机号',
                href: "${contextPath}/security/basic/customer_coupon_ticket_gift/addRider.htm?ticketGiftId=" + '${ticketGiftId!}',
                event: {
                    onClose: function () {
                        reload();
                    },
