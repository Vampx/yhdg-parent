                ...
                <tr>
                    ...
                    <td>
                        <div style="width:330px; height:150px; padding:5px; border:1px solid #ddd; overflow:auto;">
                            <ul id="oper_tree" class="easyui-tree" url="${contextPath}/security/basic/agent_role/tree.htm?id=${entity.id}&agentId=${(entity.agentId)!0}" checkbox="true" cascadeCheck="true" lines="true"></ul>
                        </div>
                    </td>
                </tr>
                <tr>
