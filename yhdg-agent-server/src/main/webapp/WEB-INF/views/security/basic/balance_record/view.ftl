    ...
    <div class="ui_table" style="padding: 0 15px;">
        <table cellpadding="0" cellspacing="0" width="100%">
            <tr>
                ...
                <td>包月：${(entity.packetPeriodMoney/100)!''}</td>
                <td>换电：${(entity.exchangeMoney/100)!''}</td>
                <td>保险：${(entity.insuranceMoney/100)!''}</td>
                <td>退款：${(entity.refundPacketPeriodMoney/100 + entity.refundInsuranceMoney/100)!''}</td>
    ...
    <div class="card-item" style="margin-top: 0;">
        <div class="card-item__head">
            <ul class="tabnav" id="tab_container_${pid}">
                <li class="active" style="font-size: 14px;"  url="${contextPath}/security/hdg/packet_period_order/select_packet_period_order.htm?agentId=${entity.agentId}&balanceDate=${entity.balanceDate}&pid=${pid}">包月收入(${(entity.packetPeriodMoney/100.00)!''})</li>
                ...
                <li style="font-size: 14px;" url="${contextPath}/security/hdg/order_refund/select_order_refund.htm?agentId=${entity.agentId}&balanceDate=${entity.balanceDate}&pid=${pid}">退款支出(${(entity.refundPacketPeriodMoney/100 + entity.refundInsuranceMoney/100)!''})</li>
            </ul>
        </div>
