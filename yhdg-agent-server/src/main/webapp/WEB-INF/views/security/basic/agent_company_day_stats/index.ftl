    ...
    <script>
        $(function () {
            $('#page_table').datagrid({
                ...
                collapsible: true,
                pagination: true,
                url: "${contextPath}/security/basic/agent_company_day_stats/page.htm?agentId=${Session['SESSION_KEY_USER'].agentId}",
                pageSize: 50,
                pageList: [50, 100],
                idField: 'id',
                frozenColumns: [[
        ...
        function exportExcel() {
            $.messager.confirm('提示信息', '确认导出数据?', function (ok) {
                if (ok) {
                    ...
                    var statsDate = $('#stats_date').datebox('getValue');
                    $.messager.progress();
                    $.post('${contextPath}/security/basic/agent_company_day_stats/export_excel.htm', {
                        statsDate: statsDate,
                        agentCompanyName: agentCompanyName
                    }, function (json) {
                        $.messager.progress('close');
                        if (json.success) {
                            document.location.href = '${contextPath}/security/basic/agent_company_day_stats/download.htm?filePath=' + json.data;
                        } else {
            ...
            <div class="content">
                ...
                <div class="panel grid_wrap" style="top: 80px">
                    <div class="toolbar clearfix">
                        <div class="float_right">
                            <@app.has_oper perm_code='basic.AgentCompanyDayStats:exportExcel'>
