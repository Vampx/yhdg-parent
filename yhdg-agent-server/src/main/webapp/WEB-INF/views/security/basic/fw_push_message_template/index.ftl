...
//                        {title: '公众号', align: 'center', field: 'mpCode', width: 80},
        ...
        function edit(id, appId) {
            App.dialog.show({
                ...
                title: '修改',
                href: "${contextPath}/security/basic/fw_push_message_template/edit.htm?appId="+appId+"&id=" + id,
                event: {
                    onClose: function() {
                        var datagrid = $('#page_table');
                        datagrid.datagrid('reload');
        ...
        function view(id, appId) {
            App.dialog.show({
                css: 'width:752px;height:510px;overflow:visible;',
                title: '查看',
                href: "${contextPath}/security/basic/fw_push_message_template/view.htm?appId="+appId+"&id=" + id
            });
        }
