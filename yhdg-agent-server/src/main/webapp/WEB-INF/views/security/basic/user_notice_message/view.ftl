<div class="popup_body">
    <div class="ui_table">
        <table cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td width="70" align="right">用户姓名：</td>
                <td><input type="text" class="text" readonly value="${(entity.userFullname)!''}"/></td>
            </tr>
            <tr>
                <td width="70" align="right">手机号码：</td>
                <td><input type="text" class="text" readonly value="${(entity.userMobile)!''}"/></td>
            </tr>
            <tr>
