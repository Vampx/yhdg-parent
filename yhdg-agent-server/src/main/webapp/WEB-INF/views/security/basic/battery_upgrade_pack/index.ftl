                ...
                columns: [
                    [
                        ...
                        {title: '备注', align: 'center', field: 'memo', width: 100},
                        {
                            ...
                            formatter: function (val, row) {
                                var html = '';
                                <@app.has_oper perm_code='9_3_2_3'>
                                    html += '<a href="javascript:view(ID)">查看</a>';
                                </@app.has_oper>
                                <@app.has_oper perm_code='9_3_2_4'>
                                    html += ' <a href="javascript:edit(ID)">修改</a>';
                                </@app.has_oper>
                                <@app.has_oper perm_code='9_3_2_5'>
                                    html += ' <a href="javascript:download(FILEPATH)">下载</a>'
                                </@app.has_oper>
                                <@app.has_oper perm_code='9_3_2_6'>
                                    html += ' <a href="javascript:facility(ID)">设备</a>'
                                </@app.has_oper>
                                <@app.has_oper perm_code='9_3_2_7'>
            ...
            <div class="content">
                ...
                <div class="panel grid_wrap">
                    <div class="toolbar clearfix">
                        <div class="float_right">
                            <@app.has_oper perm_code='9_3_2_2'>
