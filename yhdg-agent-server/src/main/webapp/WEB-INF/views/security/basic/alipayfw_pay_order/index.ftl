    ...
    <script>
        $(function() {
            $('#page_table').datagrid({
                ...
                striped: true,
                pagination: true,
                url: "${contextPath}/security/basic/alipayfw_pay_order/page.htm?<#if Session['SESSION_KEY_USER'].isSelfPlatform?? && Session['SESSION_KEY_USER'].isSelfPlatform == 1>appId<#else>agentId</#if>=${Session['SESSION_KEY_USER'].agentId}",
                fitColumns: true,
                pageSize: 50,
                pageList: [50, 100],
                idField: 'id',
                ...
                columns: [
                    [
                        ...
                        },
                        {
                            ...
                            formatter: function(val, row) {
                                var html = '';
                                <@app.has_oper perm_code='basic.AlipayfwPayOrder:view'>
...
//                appId: appId
        ...
        function view(id) {
            App.dialog.show({
                css: 'width:560px;height:300px;overflow:visible;',
                title: '查看',
                href: "${contextPath}/security/basic/alipayfw_pay_order/view.htm?id=" + id
