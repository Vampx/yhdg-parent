            ...
            <form method="post">
                <table cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td width="90" align="left">优惠券类型：</td>
                        <td>
                    ...
                    <tr>
                        <td width="70" align="left">优惠券名称：</td>
                    ...
                    <tr>
                        <td width="90" align="left">优惠券金额：</td>
    ...
    $(function () {
        ...
        win.find('button.ok').click(function () {
            ...
            if(isCommitted=="false") {
                ...
                form.form('submit', {
                    url: '${contextPath}/security/basic/customer_coupon_ticket_vehicle/create.htm',
