...
<script>
    (function () {
        ...
        $('#page_table_box_${pid}').datagrid({
            ...
            striped: true,
            pagination: true,
            url: "${contextPath}/security/basic/fw_push_message_template_detail/page.htm?templateId=${templateId}",
            pageSize: 10,
            pageList: [10, 50, 100],
            fitColumns: true,
            idField: 'id',
    ...
    function view_detail(appId, id, templateId) {
        App.dialog.show({
            ...
            title: '查看',
            href: "${contextPath}/security/basic/fw_push_message_template_detail/view.htm?appId=" + appId + "&id=" + id + "&templateId=" + templateId,
        });
    }
    ...
    function edit_detail(appId, id, templateId) {
        App.dialog.show({
            ...
            title: '修改',
            href: "${contextPath}/security/basic/fw_push_message_template_detail/edit.htm?appId=" + appId + "&id=" + id + "&templateId=" + templateId,
            event: {
                onClose: function() {
                    var datagrid = $('#page_table_box_${pid}');
                    datagrid.datagrid('reload');
    ...
    function add_${pid}(templateId,appId) {
        App.dialog.show({
            css: 'width:520px;height:393px;',
            title: '新建',
            href: "${contextPath}/security/basic/fw_push_message_template_detail/add.htm?templateId=" + templateId + "&appId=" + appId,
            event: {
                onClose: function() {
                    var datagrid = $('#page_table_box_${pid}');
                    datagrid.datagrid('reload');
