    ...
    <script>
        $(function() {
            $('#page_table').datagrid({
                ...
                striped: true,
                pagination: true,
                url: "${contextPath}/security/basic/customer_foregift_order/page.htm?agentId=${Session['SESSION_KEY_USER'].agentId}",
                fitColumns: true,
                pageSize: 50,
                pageList: [50, 100],
                idField: 'id',
                    ...
                    [
                        ...
                        },
                        {
                            ...
                            formatter: function(val, row) {
                                var html = '';
                                <@app.has_oper perm_code='basic.CustomerForegiftOrder:view'>
        ...
        function view(id) {
            App.dialog.show({
                ...
                title: '查看',
                href: "${contextPath}/security/basic/customer_foregift_order/view.htm?id=" + id
        ...
        function refund(id) {
            App.dialog.show({
                ...
                title:'退款',
                href:"${contextPath}/security/basic/customer_foregift_order/edit_refund.htm?refundFlag=1&id="+id,
                event: {
                    onClose: function() {
                        reload();
                    }
        ...
        function repulse_refund(id) {
            App.dialog.show({
                ...
                title:'退款',
                href:"${contextPath}/security/basic/customer_foregift_order/edit_repulse_refund.htm?id="+id,
                event: {
                    onClose: function() {
                        reload();
                    }
