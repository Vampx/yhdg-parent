App.uploadMaterial = function(config) {
    ...
    var start = function() {
        ...
        var agentId = getObj('agent_id').combotree('getValue');
    ...
    var onUploadStart = function(file) {
        ...
        var param = {
            groupId: getObj('group_id').combotree('getValue'),
            ...
            agentId: getObj('agent_id').combotree('getValue')
        }
    ...
    function setupSwfUpload() {
        ...
        swfupload = new SWFUpload( {
            ...
            upload_url: App.staticUrl + "/security/material/create.htm",
    ...
    App.dialog.show({
        css: 'width:700px;height:500px;padding:5px;',
        title: '上传节目',
        href: App.contextPath + "/security/yms/material/add.htm",
        event: {
            onLoad: function(id) {
                pid = $(this).attr('id');
                setupSwfUpload();
