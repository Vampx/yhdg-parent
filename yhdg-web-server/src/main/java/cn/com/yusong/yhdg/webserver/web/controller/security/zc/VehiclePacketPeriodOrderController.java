 ...
 */
@Controller
@RequestMapping(value = "/security/zc/vehicle_packet_period_order")
public class VehiclePacketPeriodOrderController extends SecurityController {
    ...
    @SecurityControl(limits = "zc.VehiclePacketPeriodOrder:list")
    @RequestMapping(value = "index.htm")
    public void index(Model model) {
        model.addAttribute(MENU_CODE_NAME, "zc.VehiclePacketPeriodOrder:list");
        ...
        model.addAttribute("vehicleOrderFlag",ConstEnum.Flag.TRUE.getValue());
    }
    ...
    public String view(Model model, String id) {
        ...
        return "/security/zc/vehicle_packet_period_order/view";
    }
    ...
    public String extendRent(Model model, String id) {
        ...
        return "/security/zc/vehicle_packet_period_order/edit_extend_rent";
    }
    ...
    public String viewBasic(Model model, String id) {
        ...
        model.addAttribute("PayTypeEnum", ConstEnum.PayType.values());
        model.addAttribute("StatusEnum", PacketPeriodOrder.Status.values());
        return "/security/zc/vehicle_packet_period_order/view_basic";
    }
    ...
    public String selectPacketPeriodOrder(Model model,Integer agentId, String balanceDate) {
        ...
        return "/security/zc/vehicle_packet_period_order/select_packet_period_order";
    }
    ...
    public String selectPacketPeriodOrder(Model model,String orderRefundId) {
        ...
        return "/security/zc/vehicle_packet_period_order/select_refund_packet_period_order";
    }
    ...
    public String editRefund(Model model, String id, int refundFlag) {
        ...
        return "/security/zc/vehicle_packet_period_order/edit_refund";
    }
    ...
    public String editRepulseRefund(Model model, String id) {
        ...
        return "/security/zc/vehicle_packet_period_order/edit_repulse_refund";
    }
