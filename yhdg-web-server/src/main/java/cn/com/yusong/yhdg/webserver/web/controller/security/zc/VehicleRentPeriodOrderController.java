...
@Controller
@RequestMapping(value = "/security/zc/vehicle_rent_period_order")
public class VehicleRentPeriodOrderController extends SecurityController {
    @Autowired
    ...
    @SecurityControl(limits = "zc.VehicleRentPeriodOrder:list")
    @RequestMapping(value = "index.htm")
    public void index(Model model) {
        model.addAttribute(MENU_CODE_NAME, "zc.VehicleRentPeriodOrder:list");
    ...
    public String view(Model model, String id) {
        ...
        return "/security/zc/vehicle_rent_period_order/view";
    }
    ...
    public String extendRent(Model model, String id) {
        ...
        return "/security/zc/vehicle_rent_period_order/edit_extend_rent";
    }
    ...
    public String viewBasic(Model model, String id) {
        ...
        model.addAttribute("PayTypeEnum", ConstEnum.PayType.values());
        model.addAttribute("StatusEnum", RentPeriodOrder.Status.values());
        return "/security/zc/vehicle_rent_period_order/view_basic";
    }
    ...
    public String selectRentPeriodOrder(Model model, String orderRefundId) {
        ...
        return "/security/zc/vehicle_rent_period_order/select_refund_rent_period_order";
    }
