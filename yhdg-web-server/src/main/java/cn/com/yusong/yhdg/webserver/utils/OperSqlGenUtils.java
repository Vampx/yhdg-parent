...
public class OperSqlGenUtils {
    ...
    private String inFile = "D:\\java_make_code\\projects\\yhdg-parent\\yhdg-web-server\\src\\main\\webapp\\WEB-INF\\oper.xml";

    private String outFile = "E:\\oper.sql";
    ...
    private void printSql() throws IOException {
        ...
        for(Menu e : menuList) {
            ...
            sb.append("insert into bas_menu(id, menu_name, parent_id, menu_pos) values (");
            sb.append("'" + e.id + "'");
            sb.append(", ");
        ...
        for(Menu e : operList) {
            ...
            StringBuilder sb = new StringBuilder();
            sb.append("insert into bas_perm(id, perm_name, depend, menu_id, order_num) values (");
            sb.append("'" + e.id + "'");
            sb.append(", ");
            sb.append("'" + e.menuName + "'");
            sb.append(", '" + e.ref + "'");
        ...
        for(Menu e : operList) {
            StringBuilder sb = new StringBuilder();
            sb.append("insert into bas_role_perm(role_id, perm_id) values(");
            sb.append(roleId);
            sb.append(", ");
            sb.append("'" + e.id + "'");
            sb.append(");");
