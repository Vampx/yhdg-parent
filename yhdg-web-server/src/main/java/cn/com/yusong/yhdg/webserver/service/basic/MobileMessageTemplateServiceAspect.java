...
public class MobileMessageTemplateServiceAspect {
    ...
    @Pointcut("execution(* cn.com.yusong.yhdg.webserver.service.basic.MobileMessageTemplateService.find(..))")
    private void find() {}
    ...
    @Pointcut("execution(* cn.com.yusong.yhdg.webserver.service.basic.MobileMessageTemplateService.update(..))")
    private void update() {}
