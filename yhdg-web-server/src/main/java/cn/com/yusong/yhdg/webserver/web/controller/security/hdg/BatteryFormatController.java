...
import cn.com.yusong.yhdg.webserver.service.hdg.BatteryFormatService;
...
public class BatteryFormatController extends SecurityController {
    ...
    @SecurityControl(limits = "hdg.BatteryFormat:list")
    @RequestMapping(value = "index.htm")
    public void index(Model model) {
        model.addAttribute(MENU_CODE_NAME, "hdg.BatteryFormat:list");
    }
