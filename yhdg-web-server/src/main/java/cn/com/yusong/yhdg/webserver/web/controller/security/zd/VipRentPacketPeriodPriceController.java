...
import cn.com.yusong.yhdg.webserver.service.zd.VipRentPacketPeriodPriceService;
...
public class VipRentPacketPeriodPriceController extends SecurityController {
	...
	public String exchangePacketPeriodPriceEdit(Model model, Long exchangeId) {
		...
		return "/security/zd/vip_rent_packet_period_price/vip_exchange_packet_period_price_edit";
	}
