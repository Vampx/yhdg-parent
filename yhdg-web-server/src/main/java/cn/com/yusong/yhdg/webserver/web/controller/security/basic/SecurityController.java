...
import cn.com.yusong.yhdg.webserver.service.basic.ImageConvertSizeService;
...
public class SecurityController extends AbstractController {
    ...
    protected File cutDown(File sourceFile, String uuid, String fileSuffix, int stand) throws IOException {
        ...
        if(fileSuffix.equals("png")) {
            MediaUtils.makeImageSnapshotGraphics2D(sourceFile, targetFile, fileSuffix, mediaInfo.width, mediaInfo.height);
        }else{
