...
public class SystemListener {
    ...
    void registerNode() throws Exception {
        ...
        children = endpoint.addChildrenChangeListener(appConfig.vehicleServerClientManager, ConstEnum.Node.NODE_VEHICLE_SERVER.getValue());
        appConfig.vehicleServerClientManager.listen(new Listener.Param(children, ConstEnum.Node.NODE_VEHICLE_SERVER.getValue()));
