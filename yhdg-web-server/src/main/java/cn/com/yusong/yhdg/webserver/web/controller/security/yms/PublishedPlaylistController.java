...
import cn.com.yusong.yhdg.webserver.service.yms.PublishedMaterialService;
import cn.com.yusong.yhdg.webserver.service.yms.PublishedPlaylistDetailService;
import cn.com.yusong.yhdg.webserver.service.yms.PublishedPlaylistService;
...
public class PublishedPlaylistController extends SecurityController {
    ...
    @SecurityControl(limits = OperCodeConst.CODE_6_3_2_1)
    @RequestMapping(value = "index.htm")
    public void index(Model model) {
        model.addAttribute(MENU_CODE_NAME, AppConstEnum.Menu.MENU_06_03_02.getValue());
    }
