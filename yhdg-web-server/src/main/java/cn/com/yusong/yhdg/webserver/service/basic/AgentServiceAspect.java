...
public class AgentServiceAspect {
    ...
    @Pointcut("execution(* cn.com.yusong.yhdg.webserver.service.basic.AgentService.update(..))")
    private void update() {}
    ...
    @Pointcut("execution(* cn.com.yusong.yhdg.webserver.service.basic.AgentService.delete(..))")
    private void delete() {}
