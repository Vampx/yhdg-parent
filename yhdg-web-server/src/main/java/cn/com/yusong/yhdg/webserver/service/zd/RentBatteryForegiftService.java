...
public class RentBatteryForegiftService {
    ...
    public ExtResult update(RentBatteryForegift entity) {
        ...
        rentBatteryForegiftMapper.update(entity.getMoney(), entity.getBatteryType(), entity.getAgentId(), entity.getMemo(), entity.getId().intValue());
        return ExtResult.successResult();
    }
    ...
    public ExtResult delete(Integer id) {
        ...
        List<RentForegiftOrder> rentForegiftOrderList = rentForegiftOrderMapper.findByForegiftIdAndStatus(rentBatteryForegift.getId().intValue(), foregiftList);
        ...
        rentPeriodPriceMapper.deleteByForegift(id);
        if (total == 0) {
