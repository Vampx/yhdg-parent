...
import cn.com.yusong.yhdg.webserver.service.basic.SystemBatteryTypeService;
...
public class SystemBatteryTypeController extends SecurityController {
	...
	@SecurityControl(limits = "basic.SystemBatteryType:list")
	@RequestMapping(value = "index.htm")
	public void index(Model model) {
		model.addAttribute(MENU_CODE_NAME, "basic.SystemBatteryType:list");
	}
