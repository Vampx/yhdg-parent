...
import cn.com.yusong.yhdg.webserver.service.hdg.ReliefStationService;
...
public class ReliefStationController extends SecurityController {
    ...
    @SecurityControl(limits = "hdg.ReliefStation:list")
    @RequestMapping(value = "index.htm")
    public void index(Model model) {
        model.addAttribute("starEnum", ReliefStation.Star.values());
        model.addAttribute(MENU_CODE_NAME, "hdg.ReliefStation:list");
    }
