...
import cn.com.yusong.yhdg.webserver.service.basic.CustomerCouponTicketGiftService;
import cn.com.yusong.yhdg.webserver.service.basic.CustomerService;
import cn.com.yusong.yhdg.webserver.service.basic.WagesDayTicketGiftService;
 ...
 */
@Controller
@RequestMapping(value = "/security/basic/customer_coupon_ticket_gift_rent")
public class CustomerCouponTicketGiftRentController extends SecurityController {
    ...
    @SecurityControl(limits = "basic.CustomerCouponTicketGiftRent:list")
    @RequestMapping(value = "index.htm")
    public void index(Model model) {
        model.addAttribute(MENU_CODE_NAME, "basic.CustomerCouponTicketGiftRent:list");
    ...
    public PageResult page(CustomerCouponTicketGift search) {
        ...
        search.setCategory(CustomerCouponTicketGift.Category.RENT.getValue());
    ...
    public ExtResult create(CustomerCouponTicketGift entity) {
        entity.setCategory(CustomerCouponTicketGift.Category.RENT.getValue());
    ...
    public String edit(long id, Model model) {
        ...
        model.addAttribute("TypeEnum", CustomerCouponTicketGift.Type.values());
        model.addAttribute("StatusEnum", ConstEnum.Flag.values());
        return "/security/basic/customer_coupon_ticket_gift_rent/edit";
    }
    ...
    public String view(long id, Model model) {
        ...
        model.addAttribute("TypeEnum", CustomerCouponTicketGift.Type.values());
        model.addAttribute("StatusEnum", ConstEnum.Flag.values());
        return "/security/basic/customer_coupon_ticket_gift_rent/view";
    }
    ...
    public String binDing(long id, Model model) {
        ...
        return "/security/basic/customer_coupon_ticket_gift_rent/bin_ding";
    }

    @RequestMapping("bin_ding_page.htm")
    @ViewModel(ViewModel.JSON)
    @ResponseBody
    ...
    public String addRider(long ticketGiftId,Model model) {
        ...
        return "/security/basic/customer_coupon_ticket_gift_rent/add_rider";
    }



    @RequestMapping("end_binding.htm")
    @ViewModel(ViewModel.JSON)
    @ResponseBody
