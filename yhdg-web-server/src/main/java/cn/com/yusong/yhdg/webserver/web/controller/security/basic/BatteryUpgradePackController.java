...
import cn.com.yusong.yhdg.webserver.service.basic.BatteryUpgradePackService;
...
public class BatteryUpgradePackController extends SecurityController{
    ...
    @SecurityControl(limits = "basic.BatteryUpgradePack:list")
    @RequestMapping("index.htm")
    public void index(String menuCode,Model model) throws Exception {
        model.addAttribute(MENU_CODE_NAME, menuCode);
        model.addAttribute(MENU_CODE_NAME, "basic.BatteryUpgradePack:list");
    }
