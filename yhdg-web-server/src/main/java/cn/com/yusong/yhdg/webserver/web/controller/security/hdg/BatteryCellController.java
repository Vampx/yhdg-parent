...
public class BatteryCellController extends SecurityController {
	...
	@SecurityControl(limits = "hdg.BatteryCell:list")
	@RequestMapping(value = "index.htm")
	public void index(Model model) {
		model.addAttribute(MENU_CODE_NAME, "hdg.BatteryCell:list");
	...
	@RequestMapping(value = "batch_import_battery_cell.htm", method = RequestMethod.POST)
	@ViewModel(ViewModel.JSON)
	@ResponseBody
	public ExtResult batchImportBatteryCell(@RequestParam("file") MultipartFile file, HttpSession session) throws IOException, BiffException {
		...
		return batteryCellService.batchImportBatteryCell(mFile, sessionUser.getUsername());
	}
