...
public class RoleService {
    ...
    public ExtResult update(Role role) {
        ...
        if (agentId == null || agentId == 0) { //系统
            ...
            for(String oper : role.getPermList()) {
                RolePerm roleOper = new RolePerm();
    ...
    public void agentWebTree(Integer id, OutputStream stream) throws IOException {
        Set<String> checkedOper = Collections.EMPTY_SET;
        if(id != null) {
        ...
        List<AgentMenu> menuList = agentMenuMapper.findAllByClientType(AgentMenu.ClientType.PC.getValue());
        ...
        List<AgentPerm> operList = agentOperMapper.findAllByClientType(AgentPerm.ClientType.PC.getValue());
        ...
        List<String> rootMenuIdList = agentMenuMapper.findRootsByClientType(AgentMenu.ClientType.PC.getValue());
        AtomicInteger seq = new AtomicInteger();
    ...
    public void agentAppTree(Integer id, OutputStream stream) throws IOException {
        Set<String> checkedOper = Collections.EMPTY_SET;
        if(id != null) {
            checkedOper = new HashSet<String>(agentRoleOperMapper.findAll(id));
        }
