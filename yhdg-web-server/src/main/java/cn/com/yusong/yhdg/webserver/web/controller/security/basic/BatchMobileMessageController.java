...
import cn.com.yusong.yhdg.webserver.service.basic.BatchMobileMessageService;
...
public class BatchMobileMessageController extends SecurityController {
    ...
    @SecurityControl(limits = "basic.BatchMobileMessage:list")
    @RequestMapping(value = "index.htm")
    public void index(Model model) {
        model.addAttribute(MENU_CODE_NAME, "basic.BatchMobileMessage:list");
    }
