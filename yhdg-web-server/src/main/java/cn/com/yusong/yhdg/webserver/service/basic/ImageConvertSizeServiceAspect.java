...
public class ImageConvertSizeServiceAspect {
    ...
    @Pointcut("execution(* cn.com.yusong.yhdg.webserver.service.basic.ImageConvertSizeService.find(..))")
    private void find() {}
    ...
    @Pointcut("execution(* cn.com.yusong.yhdg.webserver.service.basic.ImageConvertSizeService.update(..))")
    private void update() {}
