...
import cn.com.yusong.yhdg.webserver.service.hdg.BatteryReportService;
...
//        model.addAttribute(MENU_CODE_NAME, AppConstEnum.Menu.MENU_02_06_06.getValue());
    ...
    @RequestMapping(value = "view_normal_heart_report.htm")
    public String viewNormalHeartReport(Model model, String batteryId, Date createTime) {
        model.addAttribute("batteryId", batteryId);
        model.addAttribute("createTime", createTime);
        return "/security/hdg/battery_report/view_normal_heart_report";
    }

    @RequestMapping("view_normal_heart_report_page.htm")
    @ViewModel(ViewModel.JSON)
    @ResponseBody
    public PageResult viewNormalHeartReportPage(BatteryReport search) throws ParseException {
        return PageResult.successResult(batteryReportService.findNormalHeartReportPage(search));
    }
    ...
    public String view(Model model, Integer id, String batteryId, Date createTime) {
        BatteryReport entity = batteryReportService.find(id, batteryId, createTime);
    ...
    public String viewNormalHeart(Model model, Integer id, String batteryId, Date createTime) {
        BatteryReport entity = batteryReportService.find(id, batteryId, createTime);
        if (entity == null) {
            return SEGMENT_RECORD_NOT_FOUND;
        } else {
