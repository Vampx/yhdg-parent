...
public class SystemConfigServiceAspect {
    ...
    @Pointcut("execution(* cn.com.yusong.yhdg.webserver.service.basic.SystemConfigService.findConfigValue(..))")
    ...
    @Pointcut("execution(* cn.com.yusong.yhdg.webserver.service.basic.SystemConfigService.update(..))")
    private void update() {}
