...
public interface BalanceRecordMapper extends MasterMapper {
    ...
    int confirmStatusOffline(@Param("id") long id, @Param("fromStatus") int fromStatus, @Param("toStatus") int toStatus,
                             @Param("confirmTime") Date confirmTime, @Param("confirmOperator") String confirmOperator, @Param("memo") String memo, @Param("imagePath") String imagePath);
}
