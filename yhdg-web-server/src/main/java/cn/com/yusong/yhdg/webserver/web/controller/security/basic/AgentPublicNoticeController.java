...
@Controller
@RequestMapping(value = "/security/basic/agent_public_notice")
public class AgentPublicNoticeController extends SecurityController {
    ...
    public void index(Model model) {
        model.addAttribute("noticeTypeEnum", AgentPublicNotice.NoticeType.values());
    ...
    public String edit(Model model, long id) {
        ...
        return "/security/basic/agent_public_notice/edit";
    }
    ...
    public String view(Model model, long id) {
        ...
        return "/security/basic/agent_public_notice/view";
    }
}
