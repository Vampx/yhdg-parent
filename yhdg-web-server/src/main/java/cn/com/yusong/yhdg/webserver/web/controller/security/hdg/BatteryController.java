...
public class BatteryController extends SecurityController {
	...
	@RequestMapping(value = "customer_use.htm")
	public String customerUse(Model model, Battery battery) {
		model.addAttribute("entity", battery);
		return "/security/hdg/battery/customer_use";
	}

	@RequestMapping(value = "in_cabinet.htm")
	public String inCabinet(Model model, Battery battery) {
		model.addAttribute("entity", battery);
		return "/security/hdg/battery/in_cabinet";
	}

	@RequestMapping(value = "not_use.htm")
	public String notUse(Model model, Battery battery) {
		model.addAttribute("entity", battery);
		return "/security/hdg/battery/not_use";
	}
...
//        model.addAttribute(MENU_CODE_NAME, AppConstEnum.Menu.MENU_02_08_03.getValue());
	...
	public void batteryList(Model model, String cabinetId) {
