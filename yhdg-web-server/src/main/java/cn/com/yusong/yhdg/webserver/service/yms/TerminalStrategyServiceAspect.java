...
import cn.com.yusong.yhdg.webserver.entity.StrategyXml;
...
public class TerminalStrategyServiceAspect {
    ...
    @Pointcut("execution(* cn.com.yusong.yhdg.webserver.service.yms.TerminalStrategyService.find(..))")
    private void find() {}
    ...
    @Pointcut("execution(* cn.com.yusong.yhdg.webserver.service.yms.TerminalStrategyService.update(..))")
    private void update() {}

    @Pointcut("execution(* cn.com.yusong.yhdg.webserver.service.yms.TerminalStrategyService.delete(..))")
    public void delete(){}
