...
public class PartnerServiceAspect {
    ...
    @Pointcut("execution(* cn.com.yusong.yhdg.webserver.service.basic.PartnerService.find(..))")
    private void find() {}
    @Around("find()")
    ...
    @Pointcut("execution(* cn.com.yusong.yhdg.webserver.service.basic.PartnerService.update(..))")
    private void update() {}
    @Around("update()")
    ...
    @Pointcut("execution(* cn.com.yusong.yhdg.webserver.service.basic.PartnerService.delete(..))")
    private void delete() {}
    @Around("delete()")
