        ...
        <form method="post">
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" editable="false" class="text easyui-datetimebox" name="upLineTime"  value="${(entity.upLineTime?string('yyyy-MM-dd HH:mm:ss'))!''}" style="width: 183px; height: 28px;"/>
                    </td>
                </tr>
                <tr>
