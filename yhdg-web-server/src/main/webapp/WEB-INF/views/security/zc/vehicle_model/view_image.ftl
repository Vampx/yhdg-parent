<div class="popup_body">
    <div class="ui_table">
        ...
        <form method="post" id="form_${pid}" action="${contextPath}/security/zc/vehicle_model/view_image.htm?pid=${pid}&num=${num}" target="upload_iframe" enctype="multipart/form-data">
