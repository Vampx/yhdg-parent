...
<script>
    ...
    (function() {
        ...
        win.find('button.ok').click(function() {
            ...
            var url ='${contextPath}/security/zc/vehicle_rent_foregift_order/refund.htm';
            if(${refundFlag}==2){
                 url ='${contextPath}/security/zc/vehicle_rent_foregift_order/again_refund.htm';
            }
            form.form('submit', {
                url: url,
        ...
        win.find('.portrait').click(function() {
            App.dialog.show({
                ...
                title: '上传头像',
                href: "${contextPath}/security/zc/vehicle_rent_foregift_order/photo_path.htm",
                event: {
                    onClose: function() {
                    }
                }
