    ...
    <script>
        $(function () {
            $('#page_table').datagrid({
                ...
                striped: true,
                pagination: true,
                url: "${contextPath}/security/zc/vehicle_period_order/page.htm",
                fitColumns: true,
                pageSize: 50,
                pageList: [50, 100],
                idField: 'id',
                ...
                columns: [
                    [
                        ...
                        },
                        {
                            ...
                            formatter: function (val, row) {
                                var html = '';
                                <@app.has_oper perm_code='zc.VehiclePeriodOrder:view'>
        ...
        function view(id) {
            App.dialog.show({
                css: 'width:700px;height:450px;',
                title: '订单查看',
                href: "${contextPath}/security/zc/vehicle_period_order/view.htm?id=" + id
            });
        }
