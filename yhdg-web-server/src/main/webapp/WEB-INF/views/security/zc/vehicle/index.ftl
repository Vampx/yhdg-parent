    ...
    <script>
                ...
                columns: [
                    [
                        ...
                        },
                        {
                            ...
                            formatter: function (val, row) {
                                var html = '';
                                <@app.has_oper perm_code='zc.Vehicle:view'>
                                    html += ' <a href="javascript:view(\'ID\')">查看</a>';
                                </@app.has_oper>
                                <@app.has_oper perm_code='zc.Vehicle:edit'>
                                    html += ' <a href="javascript:edit(\'ID\')">修改</a>';
                                </@app.has_oper>
                                <@app.has_oper perm_code='zc.Vehicle:parameter'>
                                    html += ' <a href="javascript:parameter(\'ID\')">参数</a>';
                                </@app.has_oper>
        ...
        function parameter(id) {
            App.dialog.show({
                css: 'width:700px;height:455px;overflow:visible;',
                title: '参数',
                href: "${contextPath}/security/zc/vehicle/parameter.htm?id=" + id,
                event: {
                    onClose: function () {
                        reload();
                    },
