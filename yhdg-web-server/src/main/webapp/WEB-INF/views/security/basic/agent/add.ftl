                        ...
                        <input name="partnerId" id="partner_id_${pid}" style="height: 28px;width: 183px;" class="easyui-combobox"  editable="false" required="true"
                               data-options="url:'${contextPath}/security/basic/partner/list.htm',
                                    ...
                                    onSelect: function(node) {
                                        $('#weixinmp_id_${pid}').combobox('reload', '${contextPath}/security/basic/weixinmp/list.htm?partnerId=' + node.id);
                                        $('#alipayfw_id_${pid}').combobox('reload', '${contextPath}/security/basic/alipayfw/list.htm?partnerId=' + node.id);
                                    }
                                    "
                        />
                    </td>
