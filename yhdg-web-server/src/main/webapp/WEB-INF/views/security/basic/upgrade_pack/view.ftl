                ...
                <tr>
                    ...
                    <td>
                        <span class="radio_box">
                            <input type="radio" class="radio" name="isForce" disabled id="is_force_1" <#if entity.isForce?? && entity.isForce == 1>checked</#if>  value="1"/><label for="is_force_1">是</label>
                        </span>
                        <span class="radio_box">
                            <input type="radio" class="radio" name="isForce" disabled id="is_force_0" <#if entity.isForce?? && entity.isForce == 0>checked</#if>  value="0"/><label for="is_force_0">否</label>
                        </span>
                    </td>
                </tr>
                <tr>
