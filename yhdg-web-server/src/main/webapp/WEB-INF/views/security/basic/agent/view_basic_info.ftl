        ...
        <form>
            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td><input type="text" maxlength="5" class="text easyui-validatebox" required="true" readonly name="linkman" value="${(entity.linkman)!''}"/></td>
                </tr>
                <tr>
                    <td width="80" align="right">联系电话：</td>
                    <td><input type="text" maxlength="11" class="text easyui-validatebox" required="true" readonly name="tel" value="${(entity.tel)!''}" /></td>
                </tr>
                <tr>
