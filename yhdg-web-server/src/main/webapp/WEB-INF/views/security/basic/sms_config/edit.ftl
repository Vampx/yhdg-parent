        ...
        <form method="post">
            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td><input type="text" class="text easyui-validatebox" name="sign" value="${(entity.sign)!''}" maxlength="10"/></td>
                </tr>
                <tr>
                    ...
                    <td>
                        <select class="easyui-combobox" name="signPlace" style="height:28px; width: 182px;">
                            <#list signPlaceEnum as e>
                                <option value="${e.getValue()}" <#if (entity.signPlace)?? && e.getValue() == entity.signPlace>selected</#if> >${e.getName()}</option>
                            </#list>
                        </select>
                    </td>
                </tr>
...
<script>
    (function() {
        ...
        win.find('button.ok').click(function() {
            form.form('submit', {
                url: '${contextPath}/security/basic/sms_config/update.htm',
