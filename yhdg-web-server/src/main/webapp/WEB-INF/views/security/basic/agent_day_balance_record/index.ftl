    ...
    <script>
        $(function(){
            $('#page_table').datagrid({
                ...
                striped: true,
                pagination: true,
                url: "${contextPath}/security/basic/agent_day_balance_record/page.htm",
                fitColumns: true,
                pageSize: 50,
                pageList: [50,100],
                idField: 'id',
                ...
                columns: [
                    [
                        ...
                        {title: '退款支出', align: 'center', field: 'refundMoney', width: 40,
                            formatter: function(val) {
                                return Number(val / 100).toFixed(2);
                            }
                        },
                        ...
                        },
                        {
                            ...
                            formatter: function(val, row) {
                                var html ='';
                                <@app.has_oper perm_code='2_1_4_4'>
            ...
            <div class="content">
                ...
                <div class="panel grid_wrap">
                    <div class="toolbar clearfix">
                        <div class="float_right">
                            <@app.has_oper perm_code='2_1_4_2'>
                                <button class="btn btn_green" onclick="edit_status()">确认(公众号)</button>
                            </@app.has_oper>
                            <@app.has_oper perm_code='2_1_4_3'>
