<div class="popup_body clearfix">
    <ul class="tab_nav" id="tab_container_${pid}">
        ...
        <li url="${contextPath}/security/basic/customer_in_out_money/index.htm?customerId=${id}&pid=${pid}">客户流水信息</li>
        <li url="${contextPath}/security/basic/foregift_packet_money_transfer_record/index.htm?customerId=${id}&pid=${pid}">换电转让记录</li>
    </ul>
    <div class="tab_con">
