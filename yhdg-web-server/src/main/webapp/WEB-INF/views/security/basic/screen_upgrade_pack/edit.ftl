<div class="popup_body">
    <div class="ui_table">
        ...
        <form id="upload_form_${pid}" action="${contextPath}/security/basic/screen_upgrade_pack/upload.htm?pid=${pid}" target="frame_${pid}" method="post" enctype="multipart/form-data">
...
<script>
    ...
    (function() {
        ...
        win.find('button.ok').click(function() {
            ...
            form.form('submit', {
                url: '${contextPath}/security/basic/screen_upgrade_pack/update.htm',
