        ...
        <form method="post">
            <table cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td><input type="text" maxlength="20" readonly class="text easyui-validatebox" required="true" name="roleName" value="${(entity.roleName)!''}"/></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <div style="width:330px; height:150px; padding:5px; border:1px solid #ddd; overflow:auto;">
                            <ul id="oper_tree" class="easyui-tree" url="${contextPath}/security/basic/role/tree.htm?id=${entity.id}&agentId=${(entity.agentId)!0}" checkbox="true" cascadeCheck="true" lines="true"></ul>
                        </div>
                    </td>
                </tr>
            </table>
