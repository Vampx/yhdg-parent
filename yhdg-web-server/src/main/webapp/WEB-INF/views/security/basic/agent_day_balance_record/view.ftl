<div class="popup_body clearfix" style="background: #f7f7f7;">
    <div class="ui_table" style="padding: 0 15px;">
        <table cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td>总收入：${(entity.money/100.00)!''}</td>
                <td>包月：${(entity.packetMoney/100.00)!''}</td>
                <td>换电：${(entity.exchangeMoney/100.00)!''}</td>
                <td>退款：${(entity.refundMoney/100.00)!''}</td>
    ...
    <div class="card-item" style="margin-top: 0;">
        <div class="card-item__head">
            <ul class="tabnav" id="tab_container_${pid}">
                ...
                <li style="font-size: 14px;" url="${contextPath}/security/hdg/order_refund/select_order_refund.htm?agentId=${entity.agentId}&balanceDate=${entity.balanceDate}&pid=${pid}">退款支出(${(entity.refundMoney/100.00)!''})</li>
            </ul>
        </div>
