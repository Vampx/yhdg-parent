        ...
        <form method="post">
            <table cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td>
                        <select name="agentId" class="easyui-combotree" editable="false"  style="width: 184px; height: 28px;" required="true" url="${contextPath}/security/basic/agent/tree.htm">
                    </td>
                </tr>
                <tr>
                    <td width="100" align="right">客户手机号：</td>
                    <td><input type="text" maxlength="40" class="text easyui-validatebox" required="true" name="mobile" validType="mobile"/></td>
                </tr>
                <tr>
                    <td width="100" align="right">密码：</td>
                    <td><input type="password" maxlength="40" class="text easyui-validatebox" required="true" name="password" id="password_${pid}"/></td>
                </tr>
                <tr>
                    <td width="100" align="right">确认密码：</td>
                    <td><input type="password" maxlength="40" class="text easyui-validatebox" required="true" name="password2" id="password2_${pid}" validType="equals['#password_${pid}']"/></td>
                </tr>
                <tr>
...
<script>
    (function() {
        ...
        win.find('button.ok').click(function() {
            form.form('submit', {
                url: '${contextPath}/security/basic/laxin/create.htm',
