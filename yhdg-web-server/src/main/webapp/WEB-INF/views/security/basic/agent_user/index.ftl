    ...
    <script>
        ...
        $(function () {
            $('#page_table').datagrid({
                ...
                striped: true,
                pagination: true,
                url: "${contextPath}/security/basic/agent_user/page.htm",
                fitColumns: true,
                pageSize: 10,
                pageList: [10, 50, 100],
                idField: 'id',
                    ...
                    [
                        ...
                        },
                        {
                            ...
                            formatter: function (val, row) {
                                ...
                                <@app.has_oper perm_code='basic.AgentUser:remove'>
            ...
            $.ajax({
                ...
                success: function (text) {
                    ...
                    if (!json.success) {
                        ...
                        App.dialog.show({
                            css: 'width:580px;height:355px;overflow:visible;',
                            title: '新建',
        ...
        function view(id) {
            App.dialog.show({
                css: 'width:590px;height:325px;overflow:visible;',
                title: '查看',
