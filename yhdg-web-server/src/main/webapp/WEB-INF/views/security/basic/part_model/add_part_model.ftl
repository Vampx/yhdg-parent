        ...
        <form method="post">
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td>角色模板名称：</td>
                    <td>
                        <input type="text" name="partModelName" class="text easyui-validatebox" required="true" />
                    </td>
                </tr>
                    <tr>
                        ...
                        <td>
                            <div style="width:330px; height:150px; padding:5px; border:1px solid #ddd; overflow:auto;">
                                <ul id="perm_tree" class="easyui-tree" url="${contextPath}/security/basic/part/tree.htm" checkbox="true" cascadeCheck="true" lines="true"></ul>
                            </div>
                        </td>
                    </tr>
            </table>
