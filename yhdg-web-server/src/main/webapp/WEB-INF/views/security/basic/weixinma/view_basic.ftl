<div class="popup_body">
    <div class="ui_table">
        <form method="post">
            ...
            <input type="hidden" id="logoImagePath" name="logoImagePath" readonly value="${(entity.logoImagePath)!''}">
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td><input type="text" readonly class="text easyui-validatebox" name="appId" value="${(entity.appId)!}" style="width: 200px;"/></td>
                </tr>
                <tr>
                    <td align="right">小程序名称：</td>
                    <td><input type="text" readonly class="text easyui-validatebox" name="appName" value="${(entity.appName)!}" style="width: 200px;"/></td>
                </tr>
                <tr>
                    <td width="100" align="right">小程序秘钥：</td>
                    <td><input type="text" readonly class="text easyui-validatebox" name="appSecret"
                               value="${(entity.appSecret)!''}"/></td>
                </tr>
                <tr>
                    <td width="100" align="right">小程序商户：</td>
                    <td><input type="text" readonly class="text easyui-validatebox" name="partnerCode"
                               value="${(entity.partnerCode)!''}"/></td>
                </tr>
                <tr>
                    <td width="100" align="right">小程序商户秘钥：</td>
                    <td><input type="text" readonly class="text easyui-validatebox" name="partnerKey"
                ...
                <tr>
                    ...
                    <td><input type="text" readonly class="text easyui-validatebox" name="subscribeUrl" style="width: 560px"
