                ...
                <tr>
                    ...
                    <td>
                        <div style="width:330px; height:150px; padding:5px; border:1px solid #ddd; overflow:auto;">
                            <ul id="station_app_tree" class="easyui-tree" url="${contextPath}/security/basic/station_role/station_app_tree.htm" checkbox="true" cascadeCheck="true" lines="true"></ul>
                        </div>
                    </td>
                </tr>
            </table>
...
<script>
    ...
    (function() {
        ...
        stationAppTree.tree({
            url:"${contextPath}/security/basic/station_role/station_app_tree.htm?agentId=" + agentId
        });
        stationAppTree.tree('reload');

        var pid = '${pid}', win = $('#' + pid), form = win.find('form');
        win.find('button.ok').click(function() {

            form.form('submit', {
                url: '${contextPath}/security/basic/station_role/create.htm',
