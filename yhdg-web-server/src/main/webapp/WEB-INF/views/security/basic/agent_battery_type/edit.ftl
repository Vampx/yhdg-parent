        ...
        <div class="main battery_edit">
            ...
            <div class="c-detail">
                ...
                <form method="post" id="agent_battery_type_form">
                    ...
                    <input type="hidden" name="toBatteryType">
                    ...
                    <div class="c-line">
                        ...
                        <div class="c-line-right">
                            <input name="agentId" required="true" id="page_agent_id" class="easyui-combotree" readonly
                                   editable="false"
                                   style="width:187px;height:28px;padding-left: 8px;"
                    ...
                    <div class="c-line" style="align-items: flex-start;">
                        ...
                        <div class="c-line-right">
                            <div class="shang font1">
                                <div>
                                    <i>
                                        <input type="radio" class="radio" name="activeSingleExchange" <#if entity.activeSingleExchange?? && entity.activeSingleExchange == 1>checked</#if> value="1"/>
                                    </i>
                                    开启
                                </div>
                                <div style="margin-left: 19px;">
                                    <i>
                                        <input type="radio" class="radio" name="activeSingleExchange" <#if entity.activeSingleExchange?? && entity.activeSingleExchange == 1><#else >checked</#if> value="0"/>
                                    </i>
                                    不开启
                                </div>
                            </div>
                            <div class="xia" id="times_price"  style="display: none">单次价格
                                &nbsp;&nbsp;
                                <input class="easyui-numberspinner" required="true" name="timesPrice" value="<#if entity.timesPrice??>${((entity.timesPrice)/100)!0}</#if>" maxlength="5" style="width:184px;height: 28px;" data-options="min:0.01,precision:2"> &nbsp;&nbsp;元/次
                            </div>
                        </div>
                    </div>
...
<script>
   ...
   var activeSingleExchange =  ${(entity.activeSingleExchange)!0};
   if (activeSingleExchange == 1) {
       $("#times_price").show();
   }
        ...
        App.dialog.show({
            ...
            windowData: {
                getOk: function(config) {
                    $('#agent_battery_type_form').find('input[name=toBatteryType]').val(config.systemBatteryType.id);
    ...
    (function () {
        ...
        $('.ok').click(function () {
            var agentIdEdit = $('#page_agent_id').combobox('getValue');
            var toBatteryType = $('#agent_battery_type_form').find('input[name=toBatteryType]').val();
            ...
            $.ajax({
                ...
                async: false,
                type: 'POST',
                url: '${contextPath}/security/basic/agent_battery_type/update.htm',
                dataType: 'json',
                data: values,
