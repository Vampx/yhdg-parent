    ...
    <div class="ui_table">
        <form>
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td width="160" align="right">本次手续费金额（元）：</td>
                    <td><input type="text" class="easyui-numberspinner" readonly style="width: 182px; height: 28px;" data-options="precision:2,min:0.00" value="${((entity.feeMoney)!0)/100}"/></td>
