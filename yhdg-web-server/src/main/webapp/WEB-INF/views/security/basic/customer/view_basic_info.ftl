        ...
        <form>
            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td><input type="text" class="text easyui-datetimebox" style="width:182px;height:28px " readonly="readonly"
                ...
                <tr>
                    ...
                    <td><input type="text" id="mpOpenId" class="text" readonly="readonly"
                               value="${(entity.mpOpenId)!''}"/></td>
                    <td align="right">生活号openId：</td>
                    <td><input type="text" id="fwOpenId" class="text" readonly="readonly"
                               value="${(entity.fwOpenId)!''}"/></td>
                </tr>
                <tr>
                    <td align="right">所属站点：</td>
                    <td><input value="${(entity.belongCabinetName)!''}" type="text" class="text" readonly
                               name="belongCabinetName"/>
