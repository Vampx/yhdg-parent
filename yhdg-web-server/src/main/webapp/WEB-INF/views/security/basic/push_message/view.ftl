<div class="popup_body">
    <div class="ui_table">
        <table cellpadding="0" cellspacing="0">
            <tr>
                <td width="70" align="right">推送目标：</td>
                <td><input type="text" class="text easyui-validatebox" required="true" name="target" value="${(entity.target)!''}" maxlength="40" readonly/></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="text" class="text" readonly value="<#list messageStatusEnum as e><#if e.getValue() == entity.sendStatus>${e.getName()}</#if></#list>"/></td>
            </tr>
            <tr>
                <td align="right" valign="top" style="padding-top:10px;">推送内容：</td>
