        ...
        <form>
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td>
                        <input name="weixinmpId" id="weixinmp_id" style="height: 28px;width: 183px;" class="easyui-combobox"  editable="false"
                ...
                <td>
                    <input name="weixinmaId" id="weixinma_id" style="height: 28px;width: 183px;" class="easyui-combobox"  editable="false"
                    ...
                    <td>
                        <input name="phoneappId" id="phoneapp_id" style="height: 28px;width: 183px;" class="easyui-combobox"  editable="false"
                ...
                <tr>
                    ...
                    <td>
                        <input name="alipayfwId" id="alipayfw_id" style="height: 28px;width: 183px;" class="easyui-combobox"  editable="false"
                ...
                <tr>
                    ...
                    <td>
                        <select name="parentId" class="easyui-combotree" editable="true"  style="width: 184px; height: 28px;" url="${contextPath}/security/basic/agent/tree.htm?dummy=${'无'?url}">
                    </td>
                </tr>
                <tr>
                    <td align="right">省级运营商：</td>
                    <td>
                        <select name="provinceAgentId" id="province_agent_id_${pid}" class="easyui-combotree"   editable="true" style="width: 184px; height: 28px;"
                                data-options="
                ...
                <tr>
                    ...
                    <td>
                        <select name="cityAgentId" id="city_agent_id_${pid}" class="easyui-combotree"  editable="true"  style="width: 184px; height: 28px;"
                                data-options="
                                url:'${contextPath}/security/basic/agent/tree.htm?dummy=${'无'?url}',
                                onLoadSuccess:function() {
    ...
    (function () {
        ...
        var ok = function () {
            ...
            var values = {
                ...
                weixinmpId: form.weixinmpId.value,
                phoneappId: form.phoneappId.value,
                alipayfwId: form.alipayfwId.value,
                ...
                weixinmaId: form.weixinmaId.value,
