<div class="popup_body clearfix">
    ...
    <div class="tab_con">
        <div class="easyui-layout" style="width: 585px; height: 400px;">
            <div id="page_${pid}" data-options="region:'center', border:false, href:'${contextPath}/security/basic/agent_agent/add_basic_info.htm?pid=${pid}&agentId=${agentId!}'">
            </div>
        </div>
    </div>
</div>
    ...
    (function() {
        ...
        list.click(function() {
            ...
            if(ok) {
                ...
                $('#page_${pid}').panel('refresh', me.attr('url').replace("?id=&","?id="+win.data('id')+"&"));
            }
        });
