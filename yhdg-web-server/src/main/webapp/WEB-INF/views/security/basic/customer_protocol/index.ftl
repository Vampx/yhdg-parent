    ...
    <@app.head>
        ...
        <script type="text/javascript">
            KindEditor.ready(function(K) {
                ...
                $.post('${contextPath}/security/basic/customer_protocol/load_html.htm', {
            ...
            function ok() {
                $.post('${contextPath}/security/basic/customer_protocol/update.htm', {
                    agentId: '${Session['SESSION_KEY_USER'].agentId}',
            ...
            function cancel() {
                $.messager.confirm('提示信息', '确认重置?', function(ok) {
                    if(ok) {
                        document.location.href = '${contextPath}/security/basic/customer_protocol/index.htm'
                    }
                })
            }
        </script>
