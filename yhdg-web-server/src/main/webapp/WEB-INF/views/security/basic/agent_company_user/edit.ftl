        ...
        <div class="ui_table">
            <form method="post">
                ...
                <table cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td align="left">所属运营公司：</td>
                        <td>
                            <input name="agentCompanyId" id="agent_company_id_${pid}" class="easyui-combotree" editable="false" disabled
                                   required="true"
                                   style="width: 190px;height: 28px;" value="${(entity.agentCompanyId)!''}"
                    ...
                    <tr>
                        ...
                        <td>
                            <input class="easyui-combobox" name="agentCompanyRoleId" id="agent_company_role_id_${pid}"
                                   ...
                                   data-options="url:'${contextPath}/security/basic/agent_company_role/find_all.htm?agentCompanyId=${(entity.agentCompanyId)!''}',
                                                method:'get',
                                                valueField:'id',
                                                textField:'text',
                                                editable:false,
                                            ...
                                            onLoadSuccess:function() {
                                                   $('#agent_company_role_id_${pid}').combobox('setValue', '${(entity.agentCompanyRoleId)!''}');
                                               }
                                             "/>
                        </td>
                    </tr>
...
<script>
    ...
    (function() {
        ...
        win.find('button.ok').click(function() {
            ...
            form.form('submit', {
                url: '${contextPath}/security/basic/agent_company_user/update.htm',
