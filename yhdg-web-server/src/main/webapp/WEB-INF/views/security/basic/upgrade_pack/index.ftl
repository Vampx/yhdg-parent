    ...
    <script>
        $(function() {
            $('#page_table').datagrid({
                ...
                striped: true,
                pagination: true,
                url: "${contextPath}/security/basic/upgrade_pack/page.htm?moduleId=${Session['SESSION_KEY_USER'].moduleId}",
                fitColumns: true,
                pageSize: 10,
                pageList: [10, 50, 100],
                idField: 'id',
                    ...
                    [
                        ...
                        {title: '备注', align: 'center', field: 'memo', width: 100},
                        {
                            ...
                            formatter: function(val, row) {
                                var html = '';
                                <@app.has_oper perm_code='basic.UpgradePack:view'>
                                    html += '<a href="javascript:view(ID)">查看</a>';
                                </@app.has_oper>
                                <@app.has_oper perm_code='basic.UpgradePack:upload'>
                                    html += ' <a href="javascript:edit(ID)">上传</a>';
                                </@app.has_oper>
                                <@app.has_oper perm_code='basic.UpgradePack:download'>
        ...
        function edit(id) {
            App.dialog.show({
                ...
                title: '上传',
                href: "${contextPath}/security/basic/upgrade_pack/edit.htm?id=" + id,
                event: {
                    onClose: function() {
                        var datagrid = $('#page_table');
                        datagrid.datagrid('reload');
        ...
        function view(id) {
            App.dialog.show({
                ...
                title: '查看',
                href: "${contextPath}/security/basic/upgrade_pack/view.htm?id=" + id
            });
        }
