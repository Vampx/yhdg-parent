    ...
    <script>
        $(function() {
            $('#page_table').datagrid({
                ...
                striped: true,
                pagination: true,
                url: "${contextPath}/security/basic/agent_deposit_order/page.htm",
                fitColumns: true,
                pageSize: 10,
                pageList: [10, 50, 100],
                idField: 'id',
        ...
        function add() {
            App.dialog.show({
                css: 'width:320px;height:220px;overflow:visible;',
                title: '充值',
                ...
                <div class="content">
                    ...
                    <div class="panel grid_wrap">
                        <div class="toolbar clearfix">
                            <div class="float_right">
                                <@app.has_oper perm_code='basic.AgentDepositOrder:deposit'>
