    ...
    <div class="ui_table">
        <form method="post">
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td width="120" align="right">平台账户id：</td>
                    <td><input type="text"  readonly class="text easyui-validatebox" required="true" value="${(entity.platformAccountId)!''}"/></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td width="70" align="right">剩余金额：</td>
                    <td><input type="text"  readonly class="text easyui-validatebox" required="true" value="${(entity.balance/100)!''}"/></td>
                </tr>
                <tr>
