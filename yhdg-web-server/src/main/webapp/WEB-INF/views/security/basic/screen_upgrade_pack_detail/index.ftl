...
<script>
    (function() {
        ...
        datagrid.datagrid({
            ...
            striped: true,
            pagination: true,
            url: "${contextPath}/security/basic/screen_upgrade_pack_detail/page.htm?upgradePackId="+upgradePackId,
            fitColumns: true,
            pageSize: 10,
            pageList: [10, 50, 100],
            idField: 'id',
            ...
            columns: [
                [
                    ...
                    },
                    {
                        ...
                        width: 150,
                        formatter: function(val, row) {
                            var html = '<a href="javascript:del(\'terminalId\')">移除</a>';
                            return html.replace(/terminalId/g, row.terminalId);
                        }
                    }
                ]
            ],
        ...
        function add() {
            App.dialog.show({
                ...
                title: '增加升级屏幕',
                href: "${contextPath}/security/basic/screen_upgrade_pack_detail/add.htm",
                windowData: {
                    ok: function (checked) {
                        console.log(checked);
                        var terminalId = [];
                        ...
                        $.post('${contextPath}/security/basic/screen_upgrade_pack_detail/create.htm',
                                {
