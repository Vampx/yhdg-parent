<div class="popup_body">
    <div class="ui_table">
        <form method="post">
            ...
            <input type="hidden" name="fromWeixinmpId" value="${(entity.weixinmpId)!''}">
            <table cellpadding="0" cellspacing="0">
                <#--<tr>-->
                    ...
                    <#--<#list agentList as s>-->
                        <#--<option value="${s.getId()}" <#if entity.weixinmpId?? && entity.weixinmpId == s.getId()>selected</#if> >${s.getAgentName()}</option>-->
                    <#--</#list>-->
                    <#--</select></td>-->
                <#--</tr>-->
                <tr>
...
<script>
    (function() {
        ...
        var ok = function() {
            ...
            var values = {
                id: '${(entity.id)!''}',
                <#--weixinmpId: $('#app_id_${pid}').combobox('getValue'),-->
