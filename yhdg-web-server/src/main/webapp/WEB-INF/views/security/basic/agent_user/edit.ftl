        ...
        <form method="post">
            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td align="right">是否推送：</td>
                    <td>
                            <span class="radio_box">
                                <input type="radio" class="radio" name="isPush" id="is_push_1" <#if entity.isPush?? && entity.isPush == 1>checked</#if> value="1"/><label for="is_push_1">是</label>
                            </span>
                        <span class="radio_box">
                                <input type="radio" class="radio" name="isPush" id="is_push_0" <#if entity.isPush?? && entity.isPush == 1><#else>checked</#if> value="0"/><label for="is_push_0">否</label>
                            </span>
                        <a href="javascript:push_message(${entity.id})">推送列表</a>
                    </td>
              </tr>
                <tr>
                    ...
                    <td>
                            <span class="radio_box">
                                <input type="radio" class="radio" name="isAdmin" id="is_admin_1" <#if entity.isAdmin?? && entity.isAdmin == 1>checked</#if>
                                       value="1"/><label for="is_admin_1">是&nbsp;&nbsp;&nbsp;&nbsp;</label>
                            </span>
                        <span class="radio_box">
                                <input type="radio" class="radio" name="isAdmin" id="is_admin_0" <#if entity.isAdmin?? && entity.isAdmin == 1><#else>checked</#if> value="0"/><label
                    ...
                    <td>
                        ...
                        <span class="radio_box">
                                <input type="radio" class="radio" name="isProtected" id="is_protected_0" <#if entity.isProtected?? && entity.isProtected == 1><#else>checked</#if> value="0"/><label
                                for="is_admin_0">否</label>
                            </span>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input class="easyui-combobox" name="roleId" id="role_id_${pid}" editable="false"
                ...
                <tr>
                    <td align="right" width="120">手机号码：</td>
...
<script>
    ...
    function push_message(id) {
        App.dialog.show({
            css: 'width:690px;height:500px;overflow:visible;',
            title: '推送列表',
            href: "${contextPath}/security/basic/mp_push_message_template/view_push_message.htm?userId=" + id
        });
    }
    ...
    (function() {
        ...
        win.find('button.ok').click(function() {
            ...
            form.form('submit', {
                url: '${contextPath}/security/basic/agent_user/update.htm',
