<div class="popup_body" style="padding-left:50px;font-size: 14px;min-height: 85%;">
    <div class="ui_table">
        <form method="post">
            ...
            <input type="hidden" name="alipayfwId" value="${(template.alipayfwId)!''}">
            <div style="height: 100px;">
                <table cellpadding="0" cellspacing="0" style="float: left;">
                    ...
                    <tr>
                        <td width="70" align="left">生活号：</td>
                        <td><input type="text" class="text easyui-validatebox" name="fwCode" value="${(template.fwCode)!''}"
...
<script>
    ...
    (function() {
        ...
        win.find('button.ok').click(function() {
            ...
            var alipayfwId = win.find('input[name=alipayfwId]').val();
            var variable = $('#variable').val();
            var fwCode = win.find('input[name=fwCode]').val();
            var isActive = $('input[name=isActive]:checked').val();
            values["id"] = id;
            values["alipayfwId"] = alipayfwId;
            values["variable"] = variable;
            values["fwCode"] = fwCode;
            ...
            $(".ui_table .keyword").each(function() {
                ...
                detailMap["alipayfwId"] = alipayfwId;
            ...
            $.post('${contextPath}/security/basic/fw_push_message_template/update.htm', {
                data : $.toJSON(values)
            }, function(json) {
            <@app.json_jump/>
                if(json.success) {
