<div class="popup_body">
    <div class="ui_table">
        ...
        <form method="post" id="form_${pid}" action="${contextPath}/security/basic/balance_record/image_path.htm?pid=${pid}" method="post" target="upload_iframe" enctype="multipart/form-data">
