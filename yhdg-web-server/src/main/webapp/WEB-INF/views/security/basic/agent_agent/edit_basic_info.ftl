        ...
        <form>
            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td>
                        <input name="weixinmaId" id="weixinma_id_${pid}" style="height: 28px;width: 183px;" class="easyui-combobox"  editable="false"
                ...
                <tr>
                    ...
                    <td>
                        <input name="phoneappId" id="phoneapp_id_${pid}" style="height: 28px;width: 183px;" class="easyui-combobox"  editable="false"
