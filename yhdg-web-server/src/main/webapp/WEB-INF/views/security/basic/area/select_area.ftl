...
<div class="select_city" id="area_selector_${selectorId}">
    <input type="text" id="area_text_${selectorId}" name="company_address_${selectorId}" class="text" readonly
           value="${(areaText)!''}"
    ...
    <input type="hidden" id="province_id_${selectorId}" name="<#if namePrefix?? && namePrefix?length gt 0>${namePrefix}ProvinceId<#else>provinceId</#if>" value="${(provinceId)!''}">
    <input type="hidden" id="city_id_${selectorId}" name="<#if namePrefix?? && namePrefix?length gt 0>${namePrefix}CityId<#else>cityId</#if>" value="${(cityId)!''}">
    <input type="hidden" id="district_id_${selectorId}" name="<#if namePrefix?? && namePrefix?length gt 0>${namePrefix}DistrictId<#else>districtId</#if>" value="${(districtId)!''}">
