                ...
                columns: [
                    [
                        ...
                        },
                        {
                            ...
                            formatter: function(val, row) {
                                var html = '';
                            <@app.has_oper perm_code='hdg.BatteryCellFormat:view'>
                                html += ' <a href="javascript:view(\'ID\')">查看</a>';
                            </@app.has_oper>
                            <@app.has_oper perm_code='hdg.BatteryCellFormat:edit'>
                                html += ' <a href="javascript:edit(\'ID\')">修改</a>';
                            </@app.has_oper>
                            <@app.has_oper perm_code='hdg.BatteryCellFormat:remove'>
                                html += ' <a href="javascript:remove(\'ID\')">删除</a>';
                            </@app.has_oper>
                            <@app.has_oper perm_code='hdg.BatteryCellFormat:generateCode'>
                                html += ' <a href="javascript:cellBarcode(\'ID\')">生成条码</a>';
                            </@app.has_oper>
                            <@app.has_oper perm_code='hdg.BatteryCellFormat:viewCode'>
            ...
            <div class="content">
                ...
                <div class="panel grid_wrap">
                    <div class="toolbar clearfix">
                        <div class="float_right">
                        <@app.has_oper perm_code="hdg.BatteryCellFormat:add">
