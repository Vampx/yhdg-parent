    ...
    <script>
        $(function() {
            $('#page_table').datagrid({
                ...
                striped: true,
                pagination: true,
                url: "${contextPath}/security/hdg/shop/page.htm",
                fitColumns: true,
                pageSize: 10,
                pageList: [10, 50, 100],
                idField: 'id',
                    ...
                    [
                        ...
                        {title: '营业时间', align: 'center', field: 'workTime', width: 40},
                        {
                            ...
                            formatter: function(val, row) {
                                    ...
                                    <@app.has_oper perm_code='hdg.Shop:remove'>
        ...
        function add() {
            App.dialog.show({
                ...
                title: '新建',
                href: "${contextPath}/security/hdg/shop/add.htm",
                event: {
                    onClose: function() {
                        query();
                    }
        ...
        function edit(id) {
            App.dialog.show({
                ...
                title: '修改',
                href: "${contextPath}/security/hdg/shop/edit.htm?id=" + id ,
                event: {
                    onClose: function() {
                        query();
                    },
