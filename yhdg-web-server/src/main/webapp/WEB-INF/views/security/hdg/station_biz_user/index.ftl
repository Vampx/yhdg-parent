    ...
    <script>
        ...
        $(function () {
            $('#page_table').datagrid({
                ...
                striped: true,
                pagination: true,
                url: "${contextPath}/security/hdg/station_biz_user/page.htm",
                fitColumns: true,
                pageSize: 10,
                pageList: [10, 50, 100],
                idField: 'id',
                    ...
                    [
                        ...
                        },
                        {
                            ...
                            formatter: function (val, row) {
                                var html = '';
                                <@app.has_oper perm_code='hdg.StationBizUser:view'>
                                    html += '<a href="javascript:view(ID)">查看</a>';
                                </@app.has_oper>
                                <@app.has_oper perm_code='hdg.StationBizUser:edit'>
                                    html += ' <a href="javascript:edit(ID)">修改</a>';
                                </@app.has_oper>
                                <@app.has_oper perm_code='hdg.StationBizUser:remove'>
                ...
                success: function (text) {
                    ...
                    if (!json.success) {
                        ...
                        App.dialog.show({
                            ...
                            title: '新建',
                            href: "${contextPath}/security/hdg/station_biz_user/add.htm",
                            event: {
                                onClose: function () {
                                    reload();
                                }
        ...
        function edit(id) {
            App.dialog.show({
                css: 'width:665px;height:485px;overflow:visible;',
                title: '修改',
                href: "${contextPath}/security/hdg/station_biz_user/edit.htm?id=" + id,
                event: {
                    onClose: function () {
                        var datagrid = $('#page_table');
                        datagrid.datagrid('reload');
        ...
        function view(id) {
            App.dialog.show({
                css: 'width:665px;height:485px;overflow:visible;',
                title: '查看',
                href: "${contextPath}/security/hdg/station_biz_user/view.htm?id=" + id
            });
        }
            ...
            <div class="content">
                <div class="panel search">
                    ...
                    <table cellpadding="0" cellspacing="0" border="0">
                        <tr>
                            ...
                            <td><input type="text" class="text" id="login_name"/></td>
                ...
                <div class="panel grid_wrap">
                    <div class="toolbar clearfix">
                        <div class="float_right">
                            <@app.has_oper perm_code='hdg.StationBizUser:add'>
