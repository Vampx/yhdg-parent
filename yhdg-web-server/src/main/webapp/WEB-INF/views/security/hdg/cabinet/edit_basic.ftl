    ...
    <div class="ui_table">
        <form>
            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td>
                        <a href="javascript:getLocation()">
                            <div onmouseover="addCss($(this))" onmouseout="removeCss($(this))" style="width: 50px;height: 33px;line-height: 33px;text-align: center;color: #FFFFFF;font-size: 14px;margin-left: 30px;background-color: #4263ff;border-radius: 6px;">定位
                            </div>
                        </a>
                    </td>
                </tr>
                ...
                <tr>
                    <td width="200" align="left">电价（元/度）：</td>
                ...
                <tr>
                    <td width="200" align="left">*最大充电功率：</td>
                ...
                <tr>
                    <td width="160" align="left">开启风扇温度：</td>
                    ...
                    <td><input type="text" class="text easyui-numberspinner" name="recoilVolume"
                               data-options="min:0, max:100" style="width: 183px; height: 28px;" required="true"
...
<script>
    ...
    function addCss(obj) {
        obj.css("background-color","#1852ff");
    }
    function removeCss(obj) {
        obj.css("background-color","#4263ff");
    }
    ...
    (function () {
        ...
        var snapshot = $.toJSON({
            ...
            enableWifi: '${(entity.enableWifi)!''}',
            enableBluetooth: '${(entity.enableBluetooth)!''}',
            enableVoice: '${(entity.enableVoice)!''}',
            subtype: '${(entity.type)!''}',
            viewType: '${(entity.viewType)!''}',
            upLineStatus:'${(entity.upLineStatus)!''}',
            minExchangeVolume: '${(entity.minExchangeVolume)!''}',
            recoilVolume: '${(entity.recoilVolume)!''}',
            memo: '${(entity.memo)!''}'
        });
        ...
        var ok = function () {
            ...
            var values = {
                ...
                enableWifi: form.enableWifi.value,
                enableBluetooth: form.enableBluetooth.value,
                enableVoice: form.enableVoice.value,
                ...
                recoilVolume: form.recoilVolume.value,
