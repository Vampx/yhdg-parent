        ...
        <form>
            ...
            <table cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td><input id="duration" class="text easyui-validatebox" name="customerFullname" readonly="readonly" value="${(entity.customerFullname)!''}" style="width:182px;height:28px " ></td>
                   <#-- <td width="70" align="right" valign="top" rowspan="2" style="padding-top:10px;">退款照片：</td>
                    ...
                    <td><input id="duration" class="text easyui-validatebox" name="customerMobile" readonly="readonly" value="${(entity.customerMobile)!''}" style="width:182px;height:28px " ></td>
                </tr>
                <tr>
                    <td align="right">退款状态：</td>
                    <td>
                        <select class="easyui-combobox" required="true" readonly="readonly"  name="refundStatus" style="width:195px;height:28px ">
                ...
                <tr>
                    ...
                    <td><input type="text" class="text" style="width:182px;height:28px " name="refundMoney" readonly="readonly" value="<#if (entity.refundMoney)??>${((entity.refundMoney) / 100 + "元")!''}<#else></#if>"/></td>
                </tr>
                <tr>
                    <td align="right" valign="top" style="padding-top:10px;">备注：</td>
                    <td colspan="3"><textarea style="width:490px;" maxlength="20" readonly="readonly" name="refundReason">${(entity.refundReason)!''}</textarea></td>
                </tr>
            </table>
        </form>
    </div>
