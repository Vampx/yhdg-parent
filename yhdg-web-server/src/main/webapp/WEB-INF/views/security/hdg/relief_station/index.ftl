...
//                        },
                        ...
                        },
                        {
                            ...
                            formatter: function (val, row) {
                                var html = '';
                                <@app.has_oper perm_code='hdg.ReliefStation:view'>
                                    html += '<a href="javascript:view(ID)">查看</a>';
                                </@app.has_oper>
                                <@app.has_oper perm_code='hdg.ReliefStation:edit'>
                                    html += ' <a href="javascript:edit(ID,EDIT_FLAG)">修改</a>';
                                </@app.has_oper>
                                <@app.has_oper perm_code='hdg.ReliefStation:remove'>
        ...
        function add() {
            App.dialog.show({
                css: 'width:400px;height:445px;overflow:visible;',
                title: '新建',
            ...
            <div class="content">
                ...
                <div class="panel grid_wrap">
                    <div class="toolbar clearfix">
                        <div class="float_right">
                            <@app.has_oper perm_code='hdg.ReliefStation:add'>
