    ...
    <script>
                ...
                columns: [
                    ...
                    <#--},-->
                        ...
                        },
                        {
                            ...
                            formatter: function (val, row) {
                                var html = '';
                                <@app.has_oper perm_code='hdg.BatteryCell:view'>
                                    html += ' <a href="javascript:view(\'ID\')">查看</a>';
                                </@app.has_oper>
                                <@app.has_oper perm_code='hdg.BatteryCell:edit'>
        ...
        function download_template() {
            $.messager.confirm('提示信息', '确认下载模板?', function (ok) {
                if (ok) {
                    document.location.href = '${contextPath}/static/excel/BatteryCell.xls';
                }
            });
        }
        ...
        function import_battery_cell() {
            App.dialog.show({
                css: 'width:380px;height:150px;overflow:visible;',
                title: '上传文件',
                href: "${contextPath}/security/hdg/battery_cell/upload_file.htm",
                event: {
                    onClose: function () {
                        reload();
                    }
            ...
            <div class="content">
                ...
                <div class="panel grid_wrap" style="margin-top: 30px;">
                    <div class="toolbar clearfix">
                        ...
                        <@app.has_oper perm_code='hdg.BatteryCell:add'>
