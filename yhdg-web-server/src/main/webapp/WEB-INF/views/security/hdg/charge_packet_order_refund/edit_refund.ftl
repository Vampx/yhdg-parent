        ...
        <form method="post">
            ...
            <table cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td><input id="refund_money_${pid}" class="easyui-numberspinner"   style="width:160px;height:28px " readonly="true" required="required" value="<#if (entity.money)??>${((entity.money) / 100 + "元")!''}<#else></#if>"  data-options="min:0.00,precision:2">&nbsp;&nbsp;元</td>
                </tr>
                <tr>
...
<script>
    (function() {
        ...
        win.find('button.ok').click(function() {
            form.form('submit', {
                url: '${contextPath}/security/hdg/charge_packet_order_refund/refund.htm',
