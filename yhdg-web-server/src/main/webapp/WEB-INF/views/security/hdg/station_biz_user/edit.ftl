            ...
            <form method="post">
                ...
                <table cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="text easyui-validatebox" required="true" style="width: 180px;height: 28px;" maxlength="10" name="fullname" value="${(entity.fullname)!''}" /></td>
                    </tr>
                    <tr>
...
<script>
   ...
   /*     win.find('input[name=isAdmin]').click(function () {
        ...
        win.find('button.ok').click(function() {
            ...
            form.form('submit', {
                url: '${contextPath}/security/hdg/station_biz_user/update.htm',
