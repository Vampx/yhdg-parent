    ...
    <script>
        $(function() {
            $('#page_table').datagrid({
                ...
                striped: true,
                pagination: true,
                url: "${contextPath}/security/hdg/battery_format/page.htm",
                fitColumns: true,
                pageSize: 50,
                pageList: [50, 100],
                idField: 'id',
                ...
                columns: [
                    [
                        ...
                        },
                        {
                            ...
                            formatter: function(val, row) {
                                var html = '';
                            <@app.has_oper perm_code='hdg.BatteryFormat:view'>
                                html += ' <a href="javascript:view(\'ID\')">查看</a>';
                            </@app.has_oper>
                            <@app.has_oper perm_code='hdg.BatteryFormat:edit'>
                                html += ' <a href="javascript:edit(\'ID\')">修改</a>';
                            </@app.has_oper>
                            <@app.has_oper perm_code='hdg.BatteryFormat:remove'>
                                html += ' <a href="javascript:remove(\'ID\')">删除</a>';
                            </@app.has_oper>
                            <@app.has_oper perm_code='hdg.BatteryFormat:generateCode'>
                                html += ' <a href="javascript:cellBarcode(\'ID\')">生成条码</a>';
                            </@app.has_oper>
                            <@app.has_oper perm_code='hdg.BatteryFormat:viewCode'>
        ...
        function cellBarcode(id) {
            App.dialog.show({
                css: 'width:850px;height:560px;',
                title: '生成条码',
                href: "${contextPath}/security/hdg/battery_format/select_battery_barcode.htm?id="+id,
                windowData: {
                    ok: function(rows) {
                    }
                }
        ...
        function viewCellBarcode(id) {
            App.dialog.show({
                css: 'width:750px;height:520px;',
                title: '查看条码',
                href: "${contextPath}/security/hdg/battery_format/view_battery_barcode.htm?id="+id,
                windowData: {
                    ok: function(rows) {
                    }
                }
        ...
        function view(id) {
            App.dialog.show({
                css: 'width:650px;height:465px;overflow:visible;',
                title: '查看',
                href: "${contextPath}/security/hdg/battery_format/view.htm?id=" + id
            });
        }
        ...
        function add() {
            App.dialog.show({
                css: 'width:650px;height:465px;overflow:visible;',
                title: '新建',
                href: "${contextPath}/security/hdg/battery_format/add.htm",
                event: {
                    onClose: function() {
                        reload();
                    }
        ...
        function edit(id) {
            App.dialog.show({
                css: 'width:650px;height:465px;overflow:visible;',
                title: '修改',
                href: "${contextPath}/security/hdg/battery_format/edit.htm?id="+id,
                event: {
                    onClose: function() {
                        reload();
                    }
        ...
        function remove(id) {
            $.messager.confirm('提示信息', '确认删除?', function(ok) {
                if(ok) {
                    $.post('${contextPath}/security/hdg/battery_format/delete.htm?id=' + id , function (json) {
                        if (json.success) {
            ...
            <div class="content">
                ...
                <div class="panel grid_wrap">
                    <div class="toolbar clearfix">
                        <div class="float_right">
                        <@app.has_oper perm_code="hdg.BatteryFormat:add">
