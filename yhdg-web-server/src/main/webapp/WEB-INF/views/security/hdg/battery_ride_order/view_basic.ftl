    ...
    <div class="ui_table">
        <form>
            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td align="right"width="100">骑行距离(m)：</td>
                ...
                <tr>
                    ...
                    <td><input type="text" class="text" style="width:182px;height:28px " name="refundMoney" readonly value="${refundStatus!''}"/></td>
                    <td align="right">退款金额：</td>
                    <td><input type="text" class="text" style="width:182px;height:28px " name="refundMoney" readonly  value="<#if (entity.refundMoney)??>${((entity.refundMoney) / 100 + "元")!''}<#else></#if>"/></td>
                </tr>
                <tr>
