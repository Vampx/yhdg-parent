    ...
    <script>
        $(function() {
            $('#page_table').datagrid({
                ...
                striped: true,
                pagination: true,
                url: "${contextPath}/security/hdg/vehicle_order_history/page.htm",
                fitColumns: true,
                pageSize: 50,
                pageList: [50, 100],
                idField: 'id',
                ...
                columns: [
                    [
                        ...
                        },
                        {
                            ...
                            formatter: function(val, row) {
                                var html = '';
                                <@app.has_oper perm_code='2_4_6_1'>
                ...
                <div class="panel ztree_wrap" style="width: 110px">
                    <div class="ztree" style="width: 110px">
                        ...
                        <div class="ztree_body easyui-tree" id="suffix_tree"
                             url="${contextPath}/security/hdg/vehicle_order_history/tree.htm" lines="true"
                ...
                <div class="panel search" style="margin-left:160px;">
                    ...
                    <table cellpadding="0" cellspacing="0" border="0">
                        <tr>
                            ...
                            <td>
                                <input id="agent_id" class="easyui-combotree" editable="false" style="width: 180px;height: 28px;"
                            ...
                            <td>
                                <select id="shop_id" class="easyui-combotree" editable="false" style="width: 180px; height: 28px;"
