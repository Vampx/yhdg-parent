<div class="popup_body clearfix">
    <ul class="tab_nav" id="tab_container_${pid}">
        <li url="${contextPath}/security/hdg/packet_period_activity/edit_basic.htm?id=${entity.id}&pid=${pid}">基本信息</li>
    </ul>
    <div class="tab_con">
        <div class="easyui-layout" style="width: 590px; height: 380px;">
            <div id="page_${pid}" data-options="region:'center', border:false, href:'${contextPath}/security/hdg/packet_period_activity/edit_basic.htm?id=${entity.id}&pid=${pid}'">
            </div>
        </div>
    </div>
