        ...
        <form>
            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="text easyui-numberspinner" data-options="min:0" maxlength="20"  style="width: 184px; height: 28px;" readonly name="platformDeductMoney" value="${((entity.platformDeductMoney)!0)/100}" />
                    </td>
                </tr>
                <tr>
