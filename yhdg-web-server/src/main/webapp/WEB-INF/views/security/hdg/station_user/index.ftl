    ...
    <script>
        ...
        $(function () {
            $('#page_table').datagrid({
                ...
                striped: true,
                pagination: true,
                url: "${contextPath}/security/hdg/station_user/page.htm?stationFlag=1",
                fitColumns: true,
                pageSize: 10,
                pageList: [10, 50, 100],
                idField: 'id',
                ...
                success: function (text) {
                    ...
                    if (!json.success) {
                        ...
                        App.dialog.show({
                            ...
                            title: '新建',
                            href: "${contextPath}/security/hdg/station_user/add.htm",
                            event: {
                                onClose: function () {
                                    reload();
                                }
            ...
            <div class="content">
                ...
                <div class="panel grid_wrap">
                    <div class="toolbar clearfix">
                        <div class="float_right">
                            <@app.has_oper perm_code='hdg.StationUser:add'>
