    ...
    <script>
        $(function() {
            $('#page_table').datagrid({
                ...
                striped: true,
                pagination: true,
                url: "${contextPath}/security/hdg/packet_period_order/page.htm",
                fitColumns: true,
                pageSize: 50,
                pageList: [50, 100],
                idField: 'id',
                    ...
                    [
                        ...
                        },
                        {
                            ...
                            formatter: function(val, row) {
                                var html = '';
                                <@app.has_oper perm_code='hdg.PacketPeriodOrder:view'>
        ...
        function editExtendRent(id) {
            App.dialog.show({
                ...
                title: '延长租期',
                href: "${contextPath}/security/hdg/packet_period_order/edit_extend_rent.htm?id=" + id,
                event: {
                    onClose: function() {
                        reload();
                    }
        ...
        function refund(id) {
            App.dialog.show({
                ...
                title:'退款',
                href:"${contextPath}/security/hdg/packet_period_order/edit_refund.htm?refundFlag=1&id=" + id,
                event: {
                    onClose: function() {
                        reload();
                    }
        ...
        function repulse_refund(id) {
            App.dialog.show({
                ...
                title:'取消退款',
                href:"${contextPath}/security/hdg/packet_period_order/edit_repulse_refund.htm?id=" + id,
                event: {
                    onClose: function() {
                        reload();
                    }
