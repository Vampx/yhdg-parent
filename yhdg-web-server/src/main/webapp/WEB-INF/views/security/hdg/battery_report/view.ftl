            ...
            <div class="popup_body">
                <div class="report_table">
                    <table>
                        ...
                        <tr>
                            <td width="20%">基站信息:</td>
                            <td width="80%">${(entity.lbs)!''}</td>
                        </tr>
                        <tr>
                            <td width="20%">总电压:</td>
                            <td width="80%">
                            <#if entity.voltage ?? >
                            ${entity.voltage/1000}V
                            </#if>
                            </td>
                        </tr>
                        <tr>
                            <td width="20%">电流:</td>
                            <td width="80%">
                            <#if entity.electricity ?? >
                            ${entity.electricity/1000}A
                            </#if>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td width="80%"><a href="javascript:see_single_voltage()">${(entity.singleVoltage)!''}</a></td>
                        </tr>
                        <#if averageVoltage?? >
                        <tr id="single_voltage_${pid}" style="display: none;">
                            <td colspan="2">
                                <table>
                                    <tr>
                                        <td style="text-align: center">平均电压：<#if averageVoltage??>${(averageVoltage/1000)!''}</#if>V</td>
                                        <td style="text-align: center">最高电压：<#if maxVoltage??>${(maxVoltage/1000)!''}</#if>V</td>
                                        <td style="text-align: center">最低电压：<#if minVoltage??>${(minVoltage/1000)!''}</#if>V</td>
                                        <td style="text-align: center">压差：<#if voltageRange??>${(voltageRange)!''}</#if>mV</td>
                                    </tr>
                                </table>
                                <table>
                                    <tr>
                                        <td style="text-align: center;width: 25%;">序号</td>
                                        <td style="text-align: center;width: 25%;">电压</td>
                                        <td style="text-align: center;width: 25%;">最高压差</td>
                                        <td style="text-align: center;width: 25%;">最低压差</td>
                                    </tr>
                                    <#if mapList?? && mapList?size &gt; 0>
                                        <#list mapList as map>
                                            <tr>
                                                <td style="text-align: center">${map["no"]!''}</td>
                                                <td style="text-align: center">${(map["voltage"]/1000)!''}V</td>
                                                <td style="text-align: center">${map["maxVoltageRange"]!''}mV</td>
                                                <td style="text-align: center">${map["minVoltageRange"]!''}mV</td>
                                            </tr>
                                        </#list>
                                    </#if>
                                </table>
                        ...
                        <tr>
                            <td width="20%">当前容量：</td>
                            <td width="80%">
                            <#if entity.currentCapacity ?? >
                            ${entity.currentCapacity/1000}AH
                            </#if>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td width="20%">工作状态：</td>
                            <td width="80%">${(entity.modeName)!''}</td>
                        </tr>
                        <tr>
                            <td width="20%">保护状态：</td>
                        ...
                        <tr>
                            <td width="20%">网络连接状态：</td>
                            <td width="80%">${(entity.linkStatusName)!''}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td width="20%">静止状态时心跳间隔：</td>
                            <td width="80%"><#if (entity.motionless)?? >${entity.motionless}秒</#if></td>
                        </tr>
                        <tr>
                            <td width="20%">存储状态时心跳间隔：</td>
                            <td width="80%"><#if (entity.standby)?? >${entity.standby}秒</#if></td>
                        </tr>
                        <tr>
                            <td width="20%">休眠状态时心跳间隔：</td>
                            <td width="80%"><#if (entity.dormancy)?? >${entity.dormancy}秒</#if></td>
                        </tr>
                        <tr>
                            <td width="20%">总容量：</td>
...
<script>
    ...
    function see_single_voltage() {
        if( document.getElementById("single_voltage_${pid}").style.display == "table-row") {
            document.getElementById("single_voltage_${pid}").style.display = "none";
        }else if(document.getElementById("single_voltage_${pid}").style.display == "none") {
            document.getElementById("single_voltage_${pid}").style.display = "table-row";
        }
    }
</script>