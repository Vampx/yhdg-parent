        ...
        <form>
            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td><input type="text"  maxlength="3" class="easyui-numberspinner" id="platform_ratio_${pid}" style="height: 28px;width: 185px;" name="platformRatio" required="true"  data-options="min:0,max:100" <#if entity.platformRatio ??>value="${(entity.platformRatio)!''}"<#else >value="0"</#if> /></td>
                </tr>
                <tr>
              ...
              <#--  <tr>
                ...
                <tr>
                    ...
                    <td><input type="text"  maxlength="3" class="easyui-numberspinner" id="shop_fixed_money_${pid}" style="height: 28px;width: 185px;" name="shopFixedMoney" data-options="min:0.00,precision:2" <#if entity.shopFixedMoney ??>value="${(entity.shopFixedMoney/100)!''}"<#else> value="0"</#if> /></td>
                </tr>-->
            </table>
        </form>
    </div>
...
<script>
    ...
    (function () {
        ...
        var ok = function () {
            ...
            if(platformRatioNumber+agentRatioNumber+provinceAgentRatioNumber+cityAgentRatioNumber != 100) {
            ...
            if (snapshot != $.toJSON(values)) {
                $.ajax({
                    ...
                    async: false,
                    type: 'POST',
                    url: '${contextPath}/security/hdg/cabinet/update_ratio.htm',
                    dataType: 'json',
                    data: values,
