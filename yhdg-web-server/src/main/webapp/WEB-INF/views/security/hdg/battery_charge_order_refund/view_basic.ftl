        ...
        <form>
            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td><input type="text" class="text" style="width:182px;height:28px " name="refundMoney" value="${((entity.refundMoney)/ 100 + "元")!''}"/></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td colspan="3"><textarea style="width:490px;" maxlength="40" name="refundReason">${(entity.refundReason)!''}</textarea></td>
                </tr>
            </table>
        </form>
    </div>
