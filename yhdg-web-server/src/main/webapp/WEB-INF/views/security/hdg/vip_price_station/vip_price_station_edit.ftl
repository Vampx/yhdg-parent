<div class="state-list">
 ...
 <table id="vip_price_station_list">
    <#if vipPriceStationList?? && (vipPriceStationList?size>0) >
        <#list vipPriceStationList as vipPriceStation>
             <tr>
                 <input type="hidden" name="stationId" id="station_id" value="${(vipPriceStation.stationId)!''}">
                 <input type="hidden" name="stationName" id="station_name" value="${(vipPriceStation.stationName)!''}">
                 <td>
                     <input type="text" readonly class="text easyui-validatebox" maxlength="40" style="width:175px;height:28px " value="${(vipPriceStation.stationName)!''}"
                 </td>
                 <td>
                     <img style="cursor: pointer;" onclick="station_delete(this, ${(vipPriceStation.id)!0})" src="${app.imagePath}/delete.png">
                 </td>
             </tr>
         </#list>
    </#if>
            ...
            if(ok) {
                ...
                if (id != null) {
                    ...
                    $.ajax({
                        ...
                        async: false,
                        type: 'POST',
                        url: '${contextPath}/security/hdg/vip_price_station/delete.htm',
                        dataType: 'json',
                        data: values,
                        success: function (json) {
                        <@app.json_jump/>
