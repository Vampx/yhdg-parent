        ...
        <form method="post">
            <table cellpadding="0" cellspacing="0" >
                <tr>
                    ...
                    <td><input type="text" class="text easyui-validatebox" required="true" name="regularName" value="${(entity.regularName)!''}" maxlength="40"/></td>
                </tr>
                ...
                <tr>
                    <td>清除方式：</td>
                    <td class="left">
                        <input type="radio" class="check" name="resetType" <#if entity.resetType?? && entity.resetType == 1>checked</#if> id="mm_${pid}" value="1" /><label for="mm_${pid}">月</label>
                        <input type="radio" class="check" name="resetType" <#if entity.resetType?? && entity.resetType == 2>checked</#if> id="ww_${pid}" value="2" /><label for="ww_${pid}">周</label>
                        <input type="radio" class="check" name="resetType" <#if entity.resetType?? && entity.resetType == 3>checked</#if> id="dd_${pid}" value="3" /><label for="dd_${pid}">日</label>
                    </td>
                </tr>
                <tr><td colspan="2"><span class="border"></span></td></tr>
                <tr>
                    <td>规则方式：</td>
                    <td class="left"><input type="text" class="text" style="width: 200px;" required="true" id="regular_${pid}" name="regular" value="${(entity.regular)!''}" /></td>
                </tr>
            </table>
        </form>
    </div>
