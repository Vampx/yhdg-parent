    ...
    <script>
        $(function () {
            $('#page_table').datagrid({
                ...
                collapsible: true,
                pagination: true,
                url: "${contextPath}/security/hdg/shop_total_stats/page.htm",
                pageSize: 50,
                pageList: [50, 100],
                idField: 'id',
                frozenColumns: [[
        ...
        function exportExcel() {
            $.messager.confirm('提示信息', '确认导出数据?', function (ok) {
                if (ok) {
                    var shopName = $('#shop_name').val();
                    $.messager.progress();
                    $.post('${contextPath}/security/hdg/shop_total_stats/export_excel.htm', {
                        agentName: shopName
                    }, function (json) {
                        $.messager.progress('close');
                        if (json.success) {
                            document.location.href = '${contextPath}/security/hdg/shop_total_stats/download.htm?filePath=' + json.data;
                        } else {
            ...
            <div class="content">
                ...
                <div class="panel grid_wrap" style="top: 80px">
                    <div class="toolbar clearfix">
                        <div class="float_right">
                            <@app.has_oper perm_code='hdg.ShopTotalStats:exportExcel'>
