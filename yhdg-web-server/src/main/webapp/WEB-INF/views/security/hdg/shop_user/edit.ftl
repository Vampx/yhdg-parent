        ...
        <div class="ui_table">
            <form method="post">
                ...
                <table cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td align="left">所属门店：</td>
                        <td>
                            <input name="shopId" id="shop_id_${pid}" class="easyui-combotree" editable="false" disabled
                                   required="true"
                                   style="width: 190px;height: 28px;" value="${(entity.shopId)!''}"
                    ...
                    <tr>
                        <td align="left">角色：</td>
                        <td>
                            <input class="easyui-combobox" name="shopRoleId" id="shop_role_id_${pid}"
                                   editable="false" style="width: 190px;height: 28px;"
                                   data-options="url:'${contextPath}/security/basic/shop_role/find_all.htm?shopId=${(entity.shopId)!''}',
                                                method:'get',
                                                valueField:'id',
                                                textField:'text',
                                                editable:false,
                                            ...
                                            onLoadSuccess:function() {
                                                   $('#shop_role_id_${pid}').combobox('setValue', '${(entity.shopRoleId)!''}');
                                               }
                                             "/>
                        </td>
                    </tr>
...
<script>
    function switch_shop_${pid}() {
        //角色下拉树
        var shopId = $('#shop_id_${pid}').combotree('getValue');
        var roleCombobox = $('#shop_role_id_${pid}');
        roleCombobox.combobox({
            url: "${contextPath}/security/basic/shop_role/find_all.htm?shopId=" + shopId + ""
        });
    ...
    (function() {
        ...
        win.find('button.ok').click(function() {
            ...
            form.form('submit', {
                url: '${contextPath}/security/hdg/shop_user/update.htm',
