<@app.html>
    ...
    <script>
                        ...
                        },
                        {
                            ...
                            formatter: function (val, row) {
                                ...
                                <@app.has_oper perm_code='hdg.CabinetDegreeInput:view'>
                                    html += '<a href="javascript:view(cabinetId)">查看记录</a>';
                                </@app.has_oper>
                                return html.replace(/cabinetId/g, row.cabinetId);
                            }
                        }
                    ]
                ],
        ...
        function view(cabinetId) {
            App.dialog.show({
                css: 'width:900px;height:600px;overflow:visible;',
                title: '查看记录',
                href: "${contextPath}/security/hdg/cabinet_degree_input/view.htm?cabinetId=" + cabinetId
            });
        }
