...
//                        {title: '广告终端', align: 'center', field: 'terminalId', width: 60},
                        {
                            ...
                            formatter: function (val, row) {
                                ...
                                <#--<@app.has_oper perm_code='hdg.Cabinet:remove'>-->
                                    <#--html += ' <a href="javascript:remove(\'ID\')">删除</a>';-->
                                <#--</@app.has_oper>-->
                                <@app.has_oper perm_code='hdg.Cabinet:detail'>
                                    html += ' <a href="${contextPath}/security/main/module.htm?moduleId=3&url=${contextPath}/security/hdg/cabinet/cabinet_detail.htm?id=ID" style="color:blue;" target="view_window" >换电柜详情</a>';
                                </@app.has_oper>
        ...
        <#--function detail(id) {-->
            <#--App.dialog.show({-->
                ...
                <#--title: '查看',-->
                <#--href: "${contextPath}/security/hdg/cabinet/cabinet_detail.htm?id=" + id-->
            <#--});-->
        <#--}-->
            ...
            <div class="content">
                ...
                <div class="panel grid_wrap">
                    <div class="toolbar clearfix">
                        <div class="float_right">
                            <@app.has_oper perm_code='hdg.Cabinet:operateLog'>
                                <button class="btn btn_blue" onclick="view_operate_log()">操作日志</button>
                            </@app.has_oper>
                        </div>
                        <div class="float_right">
                            <@app.has_oper perm_code='hdg.Cabinet:dayDegreeLog'>
