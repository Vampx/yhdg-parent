    ...
    <script>
        $(function() {
            $('#page_table').datagrid({
                ...
                striped: true,
                pagination: true,
                url: "${contextPath}/security/hdg/exchange_whitelist/page.htm",
                fitColumns: true,
                pageSize: 50,
                pageList: [50, 100],
                idField: 'id',
                    ...
                    [
                        ...
                        },
                        {
                            ...
                            formatter: function(val, row) {
                                ...
                                <@app.has_oper perm_code='hdg.ExchangeWhitelist:edit'>
                                    html += ' <a href="javascript:edit(\'ID\')">修改</a>';
                                </@app.has_oper>
                                <@app.has_oper perm_code='hdg.ExchangeWhitelist:remove'>
                ...
                <div class="panel search">
                    ...
                    <table cellpadding="0" cellspacing="0" border="0">
                        <tr>
                            ...
                            <td>
                                <input name="agentId" id="agent_id" class="easyui-combotree" editable="true" style="width: 184px; height: 28px;"
