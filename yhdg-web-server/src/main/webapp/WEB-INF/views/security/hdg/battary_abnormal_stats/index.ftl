<@app.html>
    ...
    <script>
                ...
                columns: [
                    [
                        ...
                        {title: '异常原因', align: 'center', field: 'abnormalCause', width: 100},
                        {
                            ...
                            formatter: function (val, row) {
                                var html = '';
                                <@app.has_oper perm_code='hdg.BattaryAbnormalStats:view'>
                                    html += ' <a href="javascript:view(\'ID\')" style="color:blue;">查看</a>';
                                </@app.has_oper>
        ...
        function exportExcel() {
            ...
            window.location.href = "${contextPath}/security/hdg/battary_abnormal_stats/export_excel.htm?id="+id+"&agentId="+agentId+"&abnormalCause="+abnormalCause;
        }
            ...
            <div class="content">
                ...
                <div class="panel grid_wrap">
                    <div class="toolbar clearfix">
                        <div class="float_right">
                            <@app.has_oper perm_code='hdg.BattaryAbnormalStats:exportExcel'>
