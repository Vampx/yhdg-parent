    ...
    <div class="ui_table">
        <form method="post">
            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td>
                        <span class="radio_box">
                            <input type="radio" class="radio_feeType" name="feeType_1" Onchange="radio_is(this)" id="fee_type_1_1" checked  value="1" />
                                  <label for="fee_type_1_1">分期金额费率</label>
                        </span>
                        <span class="radio_box">
                            <input type="radio" class="radio_feeType" name="feeType_1" Onchange="radio_is(this)"
                                   value="2" id="fee_type_2_1"/><label for="fee_type_2_1">固定</label>
                        </span>
                        <span class="radio_box">
                            <input type="radio" class="radio_feeType" name="feeType_1" Onchange="radio_is(this)" value="3" id="fee_type_3_1"/>
                                  <label for="fee_type_3_1">无手续费</label>
                        </span>
                    </td>
                </tr>
                <tr id="fee_${pid}">
                    <td width="110" align="left"><span style="color: #FF4242">*</span><span>手续费(%)：</span></td>
                    <td>
                ...
                <tr>
                    <td  width="110" align="left">分期设置：</td>
                    <td>
                                ...
                                <td>
                                    <fieldset style="padding: 12px;">
                                        <table>
                                            <tr>
                                                <td>
                                                    <span style="font-weight: bold">第一期</span>
                                                </td>
                                            </tr>
                                ...
                                <td>
                                    <fieldset style="padding: 12px;">
                                        <table>
                                            <tr>
                                                <td>
                                                    <span style="font-weight: bold">第二期</span>
                                                </td>
                                            </tr>
                                            <tr id="min_foregift_${pid}">
                                                <td width="120" align="left">押金最低金额(%)：</td>
                                                <td>
                                                    <input type="text" class="text easyui-validatebox" readonly maxlength="3" style="width:245px;height:28px " id="min_foregift_percentage_${pid}"  name="minForegiftPercentage" value="0"/>
                                                </td>
                                            </tr>
                                            <tr id="min_packet_period_${pid}">
                                                <td width="120" align="left">租金最低金额(%)：</td>
                                                <td>
                                                    <input type="text" class="text easyui-validatebox" readonly maxlength="3" style="width:245px;height:28px " id="min_packet_period_percentage_${pid}" name="minPacketPeriodPercentage" value="0"/>
                                                </td>
                                            </tr>
                                        </table>
                                    </fieldset>
...
<div class="popup_btn" style="position: absolute; bottom: 0px; width: 100%; padding: 12px 0px;">
    ...
    <script>
        (function() {
            ...
            var lengthNum =1;
            var feeType = $('input[name="feeType_1"]').val();
            feeTypeFun(feeType);
            function feeTypeFun(val) {
                if(val == 1){
                    $('#fee_${pid}').show();
                    $('#fee_money_${pid}').hide();
            ...
            win.find('button.ok').click(function () {
                if(verification()){
                    ...
                    wins.data('feeMoney', ((feeMoney==null ||feeMoney =='')?0:feeMoney));
                    wins.data('feePercentage', ((feePercentage==null ||feePercentage =='')?0:feePercentage));
