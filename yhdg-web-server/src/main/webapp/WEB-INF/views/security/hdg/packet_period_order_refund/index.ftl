    ...
    <script>
        $(function() {
            $('#page_table').datagrid({
                ...
                striped: true,
                pagination: true,
                url: "${contextPath}/security/hdg/packet_period_order_refund/page.htm",
                fitColumns: true,
                pageSize: 50,
                pageList: [50, 100],
                idField: 'id',
                ...
                columns: [
                    [
                        ...
                        },
                        {
                            title: '套餐订单',
                            align: 'center',
                            field: 'packetPeriodOrder',
                            width: 40,
                            formatter: function (val, row) {
                                var html = '<a href="javascript:view_order(\'ID\')"  style="color: blue">明细</a>';
                        ...
                        },
                        {
                            ...
                            formatter: function(val, row) {
                                var html = '';
                                <@app.has_oper perm_code='2_2_3_2'>
                                       html += '<a href="javascript:view(\'ID\')">查看</a>';
                                </@app.has_oper>
                                if(row.refundStatus == ${APPLY_REFUND}) {
                                    <@app.has_oper perm_code='2_2_3_3'>
                                        html += ' <a href="javascript:refund(\'ID\')">退款</a>';
                                    </@app.has_oper>
                                    <@app.has_oper perm_code='2_2_3_4'>
        ...
        function view_order(id) {
            App.dialog.show({
                ...
                title: '套餐订单明细',
                href: "${contextPath}/security/hdg/packet_period_order/select_refund_packet_period_order.htm?orderRefundId=" + id
            });
        }
        ...
        function view(id) {
            App.dialog.show({
                ...
                title: '查看',
                href: "${contextPath}/security/hdg/packet_period_order_refund/view.htm?id=" + id
        ...
        function refund(id) {
            App.dialog.show({
                ...
                title:'退款',
                href:"${contextPath}/security/hdg/packet_period_order_refund/edit_refund.htm?id="+id,
                event: {
                    onClose: function() {
                        reload();
                    }
        ...
        function repulse_refund(id) {
            App.dialog.show({
                css:'width:500px;height:230px;overflow:visible;',
                title:'退款',
                href:"${contextPath}/security/hdg/packet_period_order_refund/edit_repulse_refund.htm?id="+id,
                event: {
                    onClose: function() {
                        reload();
                    }
