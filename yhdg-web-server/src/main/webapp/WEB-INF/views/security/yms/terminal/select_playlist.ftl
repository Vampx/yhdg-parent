            ...
            <div class="select_box" style="width: 200px; height:402px; float:right;">
                ...
                <div class="select_body" style="top:59px; overflow: hidden;">
                    <ul id="selected_container_${pid}">
                        <#if playlist??>
                            <li playlist_id="${(playlist.id)!0}" playlist_name="${(playlist.playlistName)!''}">
                                <span class="text">${(playlist.playlistName)!""}</span>
        ...
        <div class="search" style="margin:0 0; padding:2px 0 0 0; border-bottom:none;">
            <table cellspacing="0" cellpadding="0" border="0">
                <tr>
                    ...
                    <td style="width:140px;"><input type="text" class="text" style="width:120px;" id="palylst_name_${pid}"/></td>
...
//            }
            datagrid.datagrid('options').queryParams = {
                playlistName: $('#palylst_name_${pid}').val(),
            };
