...
public class BatteryReportServiceTest extends BaseJunit4Test {
	...
	@Test
	public void findPage() throws ParseException {
		Partner partner = newPartner(); insertPartner(partner); Agent agent = newAgent(partner.getId());
		insertAgent(agent);
	...
	@Test
	public void findNormalHeartReportPage() throws ParseException {
		Partner partner = newPartner(); insertPartner(partner); Agent agent = newAgent(partner.getId());
		insertAgent(agent);
		...
		insertBatteryReport(batteryReport, suffix);
		assertTrue(1 == service.findNormalHeartReportPage(batteryReport).getTotalItems());
		assertTrue(1 == service.findNormalHeartReportPage(batteryReport).getResult().size());
	}
