...
public class CabinetBoxServiceTest extends BaseJunit4Test {
    ...
    public void updateStatus() {
        ...
        cabinetBox.setIsActive(ConstEnum.Flag.FALSE.getValue());
        //assertTrue(service.updateIsActive(cabinetBox).isSuccess());
        assertEquals(service.find(cabinet.getId(), cabinetBox.getBoxNum()).getIsActive(), cabinetBox.getIsActive());
    }*/
    ...
    public void findBySubcabinet() {
        ...
        assertTrue(1 == service.findBySubcabinet(cabinet.getId()).size());
    }
}
