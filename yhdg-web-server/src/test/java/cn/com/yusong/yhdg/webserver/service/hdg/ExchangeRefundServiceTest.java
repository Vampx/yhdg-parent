...
public class ExchangeRefundServiceTest extends BaseJunit4Test {
    ...
    public void findPage() {
        ...
        Page page = refundService.findPage(customer);
    ...
    public void find() {
        ...
        Customer object = refundService.find(customer.getId());
...
//        customerForegiftOrder.setPayType(ConstEnum.PayType.WEIXIN.getValue());//支付类型
        ...
        //押金退款
        refundService.refund("aaa", CustomerRefundRecord.RefundType.BALANCE.getValue(), CustomerRefundRecord.SourceType.HDGFOREGIFT.getValue(), customerForegiftOrder.getId(), 200, customerRefundRecord.getId(), null, true);
    ...
    public void refund_2() throws Exception{
        ...
        //押金退款
        refundService.refund("aaa", CustomerRefundRecord.RefundType.RETURN.getValue(), CustomerRefundRecord.SourceType.HDGFOREGIFT.getValue(), customerForegiftOrder.getId(), 200, null, "ssssssss", true);
    ...
    public void refund_4() throws Exception{
        ...
        //包时段套餐退款
        refundService.refund("aaa", CustomerRefundRecord.RefundType.RETURN.getValue(), CustomerRefundRecord.SourceType.HDGPACKETPERIOD.getValue(), packetPeriodOrder.getId(), 100, null, "ssssssss", true);
    ...
    public void refund_6() throws Exception{
        ...
        //保险退款
        refundService.refund("aaa", CustomerRefundRecord.RefundType.RETURN.getValue(), CustomerRefundRecord.SourceType.HDGINSURANCE.getValue(), insuranceOrder.getId(), 100, null, "ssssssss", true);
    ...
    public void doRefund() {
        ...
        refundService.doRefund(CustomerRefundRecord.SourceType.HDGFOREGIFT.getValue(), CustomerRefundRecord.RefundType.RETURN.getValue(),CustomerInOutMoney.BizType.IN_CUSTOMER_FOREGIFT_REFUND.getValue(),
    ...
    public void addPayOrderRefund() {
        ...
        refundService.addPayOrderRefund(weixinPayOrder, customerForegiftOrder.getPayType(), weixinPayOrder.getSourceType(), customerForegiftOrder.getMoney());
