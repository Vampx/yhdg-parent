 ...
 */
public class InAlipayDIYQRCodeEnterExecutor extends BaseExecutor implements ActionExecutor {

    /** 线程池 */
    private static ExecutorService executors = Executors.newSingleThreadExecutor();

    public InAlipayDIYQRCodeEnterExecutor(Alipayfw alipayfw, AlipayClient alipayClient, JSONObject bizContent) {
    ...
    public String execute() throws Exception {
        ...
        try {
            ...
            //1. 首先同步构建ACK响应
            syncResponseMsg = AlipayMsgBuildUtil.buildBaseAckMsg(alipayfw.getAppId(), fromUserId);
