...
import cn.com.yusong.yhdg.common.protocol.msg06.Msg061000001;
import cn.com.yusong.yhdg.common.protocol.msg06.Msg062000001;
 ...
 */
@Component
public class Biz061000001 extends AbstractBiz {
    @Autowired
    ...
    public void doBiz(ChannelHandlerContext context, Map<String, Object> attributes, Object message) throws Exception {
        Msg061000001 request = (Msg061000001) message;
        Msg062000001 response = new Msg062000001();
        ...
        //处理心跳
        //Map heartParam1 = (Map)YhdgUtils.decodeJson(request.json, Map.class);
        ...
        if (!StringUtils.isEmpty(heartParam.IMEI)) {
            heartParam.heartType = BatteryParameter.HeartType.NORMAL_HEART.getValue();
