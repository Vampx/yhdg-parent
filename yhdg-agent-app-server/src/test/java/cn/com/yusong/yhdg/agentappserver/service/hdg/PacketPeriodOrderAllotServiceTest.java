...
public class PacketPeriodOrderAllotServiceTest extends BaseJunit4Test {
    @Autowired
    private PacketPeriodOrderAllotService service;

    PacketPeriodOrderAllot packetPeriodOrderAllot;
    ...
    public void setUp() throws Exception {
        ...
        packetPeriodOrderAllot = newPacketPeriodOrderAllot(partner.getId(), agent.getId(), cabinet.getId(), shop.getId(), suffix);
    }
...
//        packetPeriodOrderAllot.setOrgType(IncomeRatioHistory.OrgType.SHOP.getValue());
//        packetPeriodOrderAllot.setServiceType(PacketPeriodOrderAllot.ServiceType.INCOME.getValue());
//        packetPeriodOrderAllot.setStatsDate("2019-06-23");
//        insertPacketPeriodOrderAllot(packetPeriodOrderAllot);
//
//        List<PacketPeriodOrderAllot> shopDayIncome = service.findShopDayIncome(IncomeRatioHistory.OrgType.SHOP.getValue(), shop.getId(), PacketPeriodOrderAllot.ServiceType.INCOME.getValue(), "2019-06-23", suffix);
//
...
//    }
    ...
    public void findShopMonthIncome() throws ParseException {
        ...
        List<PacketPeriodOrderAllot> shopDayIncome = service.findShopMonthIncome(IncomeRatioHistory.OrgType.SHOP.getValue(), shop.getId(), PacketPeriodOrderAllot.ServiceType.INCOME.getValue(), suffix, beginDate, endDate);
