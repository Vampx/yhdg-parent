...
@Controller("agent_api_v1_shop_basic_auth_code")
@RequestMapping(value = "/agent_api/v1/shop/basic/auth_code")
public class AuthCodeController extends ApiController {
    ...
    public RestResult validate(@Valid @RequestBody ValidateParam param) {
        ...
        memCachedClient.set(CacheKey.key(CacheKey.K_SHOP_ID_V_UUID, shop.getId()), key, MemCachedConfig.CACHE_FIVE_MINUTE);
