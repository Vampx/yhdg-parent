...
@Controller("agent_api_v1_agentcompany_basic_auth_code")
@RequestMapping(value = "/agent_api/v1/agentcompany/basic/auth_code")
public class AuthCodeController extends ApiController {
    ...
    public RestResult validate(@Valid @RequestBody ValidateParam param) {
        ...
        memCachedClient.set(CacheKey.key(CacheKey.K_AGENT_COMPANY_ID_V_UUID, agentCompany.getId()), key, MemCachedConfig.CACHE_FIVE_MINUTE);
